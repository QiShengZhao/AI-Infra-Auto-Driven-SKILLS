...
- Motivation: Title: "Add flashinfer && Oultines"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `README.md`, `3rdparty/flashinfer`; technical summary: Covers "Add flashinfer && Oultines"; the main implementation surface is `README.md`, `3rdparty/flashinfer`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Feature] Support Sparse Attention and KV cache scheduling between CPU and GPU for GQA/DSA."; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/layers/attention/flashattention_backend.py`, `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/sparse_attention/kernels/attention/flash_fwd_sm100.py`; technical summary: Covers "[Feature] Support Sparse Attention and KV cache scheduling between CPU and GPU for GQA/DSA."; the main implementation surface is `python/sglang/srt/layers/attention/flashattention_backend.py`, `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/sparse_attention/kernels/attention/flash_fwd_sm100.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Add DeepSeek-V3.2 Tool Call Template"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `examples/chat_template/tool_chat_template_deepseekv32.jinja`; technical summary: Covers "Add DeepSeek-V3.2 Tool Call Template"; the main implementation surface is `examples/chat_template/tool_chat_template_deepseekv32.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Feature] Add a fast-topk to sgl-kernel for DeepSeek v3.2"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `sgl-kernel/csrc/elementwise/topk.cu`, `sgl-kernel/tests/test_topk.py`, `sgl-kernel/python/sgl_kernel/top_k.py`; technical summary: Covers "[Feature] Add a fast-topk to sgl-kernel for DeepSeek v3.2"; the main implementation surface is `sgl-kernel/csrc/elementwise/topk.cu`, `sgl-kernel/tests/test_topk.py`, `sgl-kernel/python/sgl_kernel/top_k.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[CI] Add Basic Test for DeepSeek V3.2"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `test/srt/test_deepseek_v32_basic.py`, `.github/workflows/pr-test.yml`, `scripts/ci/ci_install_dependency.sh`; technical summary: Covers "[CI] Add Basic Test for DeepSeek V3.2"; the main implementation surface is `test/srt/test_deepseek_v32_basic.py`, `.github/workflows/pr-test.yml`, `scripts/ci/ci_install_dependency.sh`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[PD] Add PD support for hybrid model (Qwen3-Next, DeepSeek V3.2 Exp)"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/mem_cache/memory_pool.py`, `python/sglang/srt/disaggregation/mooncake/conn.py`; technical summary: Covers "[PD] Add PD support for hybrid model (Qwen3-Next, DeepSeek V3.2 Exp)"; the main implementation surface is `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/mem_cache/memory_pool.py`, `python/sglang/srt/disaggregation/mooncake/conn.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Draft] Support MTP for DeepSeek-V3.2"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/srt/configs/model_config.py`; technical summary: Covers "[Draft] Support MTP for DeepSeek-V3.2"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/srt/configs/model_config.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "(beta)support context parallel with deepseekv3.2-DSA"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: metadata-only PR card; technical summary: GitHub returned an empty changed-file list for "(beta)support context parallel with deepseekv3.2-DSA"; this card records PR metadata, the missing-patch state, and validation risks without inventing file evidence.
...
- Motivation: Title: "Fix Illegal Instruction/IMA errors when using DP attention with DeepSeek-V3.2 models"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/dp_attention.py`; technical summary: Covers "Fix Illegal Instruction/IMA errors when using DP attention with DeepSeek-V3.2 models"; the main implementation surface is `python/sglang/srt/layers/dp_attention.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Doc] Fix format for deepseek v3.2 document"; model line: DeepSeek V3.2; category: bug fix; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "[Doc] Fix format for deepseek v3.2 document"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Test] Add dsv3.2 nsa backend testing"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `test/srt/test_deepseek_v32_nsabackend.py`, `test/srt/run_suite.py`; technical summary: Covers "[Test] Add dsv3.2 nsa backend testing"; the main implementation surface is `test/srt/test_deepseek_v32_nsabackend.py`, `test/srt/run_suite.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[Doc] Small update of DeepSeek v3.2 document"; model line: DeepSeek V3.2; category: bug fix; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "[Doc] Small update of DeepSeek v3.2 document"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Update deepseek_v32.md"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "Update deepseek_v32.md"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Bug] Fix NSA Backend KV-Buffer Shape Mismatch in DeepSeek-V3.2"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/mem_cache/memory_pool.py`; technical summary: Covers "[Bug] Fix NSA Backend KV-Buffer Shape Mismatch in DeepSeek-V3.2"; the main implementation surface is `python/sglang/srt/mem_cache/memory_pool.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepseekV32]: use `_concat_mla_absorb_q_general` to replace `torch.cat`"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[DeepseekV32]: use `_concat_mla_absorb_q_general` to replace `torch.cat`"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Deepseek V3.2] Use torch.compile to speed up torch.cat in nsa"; model line: DeepSeek V3.2; category: model implementation change; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[Deepseek V3.2] Use torch.compile to speed up torch.cat in nsa"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "DeepSeek V3.2 indexer RoPE fix"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "DeepSeek V3.2 indexer RoPE fix"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix nightly test failures: NSA indexer dtype and CPP radix cache init"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "Fix nightly test failures: NSA indexer dtype and CPP radix cache init"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Revert "Fix nightly test failures: NSA indexer dtype and CPP radix cache init""; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "Revert "Fix nightly test failures: NSA indexer dtype and CPP radix cache init""; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix NSA Bug in Centralize NSA Dispatch Logic"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "Fix NSA Bug in Centralize NSA Dispatch Logic"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "feat: DeepSeek new v3.2 encoding"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `python/sglang/srt/entrypoints/openai/encoding_dsv32.py`, `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "feat: DeepSeek new v3.2 encoding"; the main implementation surface is `python/sglang/srt/entrypoints/openai/encoding_dsv32.py`, `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Doc] Fix DeepSeek V32 Doc"; model line: DeepSeek V3.2; category: bug fix; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "[Doc] Fix DeepSeek V32 Doc"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Tiny]Small fixes in deepseek v32 doc"; model line: DeepSeek V3.2; category: bug fix; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "[Tiny]Small fixes in deepseek v32 doc"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Test] Add test suite for NSA backend"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `python/sglang/test/attention/test_nsa_backend.py`; technical summary: Covers "[Test] Add test suite for NSA backend"; the main implementation surface is `python/sglang/test/attention/test_nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepSeek V3.2] Proper drop_thinking logic"; model line: DeepSeek V3.2; category: model implementation change; main diff: `python/sglang/srt/entrypoints/openai/serving_chat.py`; technical summary: Covers "[DeepSeek V3.2] Proper drop_thinking logic"; the main implementation surface is `python/sglang/srt/entrypoints/openai/serving_chat.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix: dpskv32 chat history processing, default drop_thinking to true"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/entrypoints/openai/serving_chat.py`; technical summary: Covers "fix: dpskv32 chat history processing, default drop_thinking to true"; the main implementation surface is `python/sglang/srt/entrypoints/openai/serving_chat.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "feat(ds32): support tag for deepseek 3.2 tool call"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "feat(ds32): support tag for deepseek 3.2 tool call"; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix(DeepSeek-V3.2 function_call): fix streaming content loss in DeepSeekV32Detector"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "fix(DeepSeek-V3.2 function_call): fix streaming content loss in DeepSeekV32Detector"; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[sgl-kernel] Update flashmla to include fp8 sparse_mla optimizations"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `sgl-kernel/cmake/flashmla.cmake`; technical summary: Covers "[sgl-kernel] Update flashmla to include fp8 sparse_mla optimizations"; the main implementation surface is `sgl-kernel/cmake/flashmla.cmake`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "feat: DeepSeek-V3.2 Streaming tool call output"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "feat: DeepSeek-V3.2 Streaming tool call output"; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "feat(dsv32): better error handling for DeepSeek-v3.2 encoder"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/entrypoints/openai/encoding_dsv32.py`; technical summary: Covers "feat(dsv32): better error handling for DeepSeek-v3.2 encoder"; the main implementation surface is `python/sglang/srt/entrypoints/openai/encoding_dsv32.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Feature] Enable return routed experts"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/layers/moe/routed_experts_capturer.py`, `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/managers/detokenizer_manager.py`; technical summary: Covers "[Feature] Enable return routed experts"; the main implementation surface is `python/sglang/srt/layers/moe/routed_experts_capturer.py`, `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/managers/detokenizer_manager.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix ds3.2 nsa backend prefill TBO"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "fix ds3.2 nsa backend prefill TBO"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[1/N][Sparse With Hicache]: Add Sparse Interface"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/mem_cache/sparsity/algorithms/base_algorithm.py`, `python/sglang/srt/mem_cache/sparsity/algorithms/quest_algorithm.py`, `python/sglang/srt/mem_cache/sparsity/algorithms/deepseek_nsa.py`; technical summary: Covers "[1/N][Sparse With Hicache]: Add Sparse Interface"; the main implementation surface is `python/sglang/srt/mem_cache/sparsity/algorithms/base_algorithm.py`, `python/sglang/srt/mem_cache/sparsity/algorithms/quest_algorithm.py`, `python/sglang/srt/mem_cache/sparsity/algorithms/deepseek_nsa.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Tool Call][DSV32] Streamline function call parameters"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "[Tool Call][DSV32] Streamline function call parameters"; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[cp] bug fix for dsv3.2 cp"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/hardware_backend/npu/modules/deepseek_v2_attention_mla_npu.py`; technical summary: Covers "[cp] bug fix for dsv3.2 cp"; the main implementation surface is `python/sglang/srt/hardware_backend/npu/modules/deepseek_v2_attention_mla_npu.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[cp] assert dsv3.2 cp in pd decode mode"; model line: DeepSeek V3.2; category: model implementation change; main diff: `python/sglang/srt/server_args.py`; technical summary: Covers "[cp] assert dsv3.2 cp in pd decode mode"; the main implementation surface is `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-0, 8 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[Deepseek V3.2] Enable TRTLLM Allreduce Fusion"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/server_args.py`; technical summary: Covers "[Deepseek V3.2] Enable TRTLLM Allreduce Fusion"; the main implementation surface is `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix: unimplemented methods in BaseIndexerMetadata"; model line: DeepSeek V3.2; category: bug fix; main diff: `test/registered/kernels/test_nsa_indexer.py`; technical summary: Covers "fix: unimplemented methods in BaseIndexerMetadata"; the main implementation surface is `test/registered/kernels/test_nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[1/n]deepseek_v2.py Refactor: attention backend handlers and forward method definition"; model line: DeepSeek V3.2; category: model implementation change; main diff: `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/deepseek_common/attention_backend_handler.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_methods.py`; technical summary: Covers "[1/n]deepseek_v2.py Refactor: attention backend handlers and forward method definition"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/deepseek_common/attention_backend_handler.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_methods.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "add doc for dsv32 cp+pp"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "add doc for dsv32 cp+pp"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +2/-2, 18 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Update deepseekV32 Cp doc"; model line: DeepSeek V3.2; category: bug fix; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "Update deepseekV32 Cp doc"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] Add DeepSeek-V3.2 and VLMs model in nightly tests"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `test/registered/amd/accuracy/mi35x/test_deepseek_v32_eval_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_v32_mtp_perf_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_v32_basic_perf_mi35x.py`; technical summary: Covers "[AMD] Add DeepSeek-V3.2 and VLMs model in nightly tests"; the main implementation surface is `test/registered/amd/accuracy/mi35x/test_deepseek_v32_eval_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_v32_mtp_perf_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_v32_basic_perf_mi35x.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix NSA indexer in the nightly test"; model line: DeepSeek V3.2; category: bug fix; main diff: `test/registered/kernels/test_nsa_indexer.py`; technical summary: Covers "Fix NSA indexer in the nightly test"; the main implementation surface is `test/registered/kernels/test_nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] fix amd ci dpskv32"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `test/registered/amd/test_deepseek_v32_basic.py`, `test/registered/amd/test_deepseek_v32_mtp.py`; technical summary: Covers "[AMD] fix amd ci dpskv32"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `test/registered/amd/test_deepseek_v32_basic.py`, `test/registered/amd/test_deepseek_v32_mtp.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix NSA indexer test and move it to pre commit test"; model line: DeepSeek V3.2; category: bug fix; main diff: `test/registered/kernels/test_nsa_indexer.py`; technical summary: Covers "Fix NSA indexer test and move it to pre commit test"; the main implementation surface is `test/registered/kernels/test_nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepSeek-V3.2] Fix TRT-LLM NSA in target_verify/draft_extend"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[DeepSeek-V3.2] Fix TRT-LLM NSA in target_verify/draft_extend"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Link: https://github.com/sgl-project/sglang/pull/17609
- Status/date: merged / 2026-01-26
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 12 files, +41/-279, 472 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Merge performance/accuracy test suites into regular stage-b suites"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `.github/workflows/pr-test.yml`, `python/sglang/test/test_utils.py`, `test/run_suite.py`; technical summary: Covers "Merge performance/accuracy test suites into regular stage-b suites"; the main implementation surface is `.github/workflows/pr-test.yml`, `python/sglang/test/test_utils.py`, `test/run_suite.py`. File-level evidence, code excerpts, and validation risks are preserved below.
- Key implementation: `.github/workflows/pr-test.yml` modified +12/-257 (269 lines); hunks: -274,19 +274,14 @@ jobs:; -841,6 +836,9 @@ jobs:; `python/sglang/test/test_utils.py` modified +10/-0 (10 lines); hunks: -1495,6 +1495,10 @@ def run_bench_one_batch(model, other_args):; -1517,6 +1521,12 @@ def run_bench_one_batch(model, other_args):; symbols: run_bench_one_batch, touching `run_bench_one_batch`; `test/run_suite.py` modified +1/-4 (5 lines); hunks: -22,6 +22,7; -33,12 +34,8; `test/registered/eval/test_eval_accuracy_large.py` modified +2/-2 (4 lines); hunks: -19,8 +19,8; symbols: TestEvalAccuracyLarge, touching `TestEvalAccuracyLarge`.
- Code diff details:
  - `.github/workflows/pr-test.yml` modified +12/-257 (269 lines); hunks: -274,19 +274,14 @@ jobs:; -841,6 +836,9 @@ jobs:
  - `python/sglang/test/test_utils.py` modified +10/-0 (10 lines); hunks: -1495,6 +1495,10 @@ def run_bench_one_batch(model, other_args):; -1517,6 +1521,12 @@ def run_bench_one_batch(model, other_args):; symbols: run_bench_one_batch
  - `test/run_suite.py` modified +1/-4 (5 lines); hunks: -22,6 +22,7; -33,12 +34,8
  - `test/registered/eval/test_eval_accuracy_large.py` modified +2/-2 (4 lines); hunks: -19,8 +19,8; symbols: TestEvalAccuracyLarge
  - `test/registered/eval/test_moe_eval_accuracy_large.py` modified +2/-2 (4 lines); hunks: -19,8 +19,8; symbols: TestMoEEvalAccuracyLarge
- Key code excerpts:
...
- Reviewed files:
  - ci: `.github/workflows/pr-test.yml` modified +12/-257
...
- Motivation: Title: "[DeepSeek] Update tests and document for DeepSeek V3.2 NVFP4 checkpoint"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "[DeepSeek] Update tests and document for DeepSeek V3.2 NVFP4 checkpoint"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DSv32] Overlap indexer qk projection and activation quant"; model line: DeepSeek V3.2; category: model implementation change; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "[DSv32] Overlap indexer qk projection and activation quant"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Add tool call tests for DeepSeek V3.2 in nightly CI"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `test/registered/8-gpu-models/test_deepseek_v32.py`; technical summary: Covers "Add tool call tests for DeepSeek V3.2 in nightly CI"; the main implementation surface is `test/registered/8-gpu-models/test_deepseek_v32.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix: fixed aux hidden state index out of range when using eagle3 with nsa cp"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "fix: fixed aux hidden state index out of range when using eagle3 with nsa cp"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix Bug on dsv3.2"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "Fix Bug on dsv3.2"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[V3.2] Change default CP token split method to `--round-robin-split`"; model line: DeepSeek V3.2; category: model implementation change; main diff: `docs/basic_usage/deepseek_v32.md`; technical summary: Covers "[V3.2] Change default CP token split method to `--round-robin-split`"; the main implementation surface is `docs/basic_usage/deepseek_v32.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 1 files, +100/-0, 101 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Add DeepSeek V32 PD disaggregation test"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `test/registered/distributed/test_disaggregation_deepseek_v32.py`; technical summary: Covers "Add DeepSeek V32 PD disaggregation test"; the main implementation surface is `test/registered/distributed/test_disaggregation_deepseek_v32.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix dsv32 encode_messages"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/entrypoints/openai/serving_chat.py`, `python/sglang/srt/parser/jinja_template_utils.py`; technical summary: Covers "Fix dsv32 encode_messages"; the main implementation surface is `python/sglang/srt/entrypoints/openai/serving_chat.py`, `python/sglang/srt/parser/jinja_template_utils.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix model loading for DeepSeek-V3.2-AWQ"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix model loading for DeepSeek-V3.2-AWQ"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[AMD] Fix mi35x dsv32 mtp nightly"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[AMD] Fix mi35x dsv32 mtp nightly"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix NSA FP8 KV cache path for both-trtllm MHA one-shot"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mha.py`; technical summary: Covers "Fix NSA FP8 KV cache path for both-trtllm MHA one-shot"; the main implementation surface is `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mha.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DSv32] Fix MTP and CP compatability"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_nextn.py`; technical summary: Covers "[DSv32] Fix MTP and CP compatability"; the main implementation surface is `python/sglang/srt/models/deepseek_nextn.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Perf] O(1) expert weight matching in DeepSeek weight loader"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `python/sglang/srt/models/deepseek_common/deepseek_weight_loader.py`, `test/unit/test_deepseek_weight_loader.py`; technical summary: Covers "[Perf] O(1) expert weight matching in DeepSeek weight loader"; the main implementation surface is `python/sglang/srt/models/deepseek_common/deepseek_weight_loader.py`, `test/unit/test_deepseek_weight_loader.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix NSA CP positions mismatch in eagle NextN model"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_nextn.py`; technical summary: Covers "Fix NSA CP positions mismatch in eagle NextN model"; the main implementation surface is `python/sglang/srt/models/deepseek_nextn.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] Enable cudagraph for aiter nsa backend and add aiter impl for nsa pr…"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/triton_kernel.py`; technical summary: Covers "[AMD] Enable cudagraph for aiter nsa backend and add aiter impl for nsa pr…"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/triton_kernel.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Tool Call] Stream DeepSeek-V3.2 function call parameters in JSON format."; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "[Tool Call] Stream DeepSeek-V3.2 function call parameters in JSON format."; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[NSA] Fix line-too-long lint in `can_nsa_prefill_cp_round_robin_split`"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa/utils.py`; technical summary: Covers "[NSA] Fix line-too-long lint in `can_nsa_prefill_cp_round_robin_split`"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/utils.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] Support context parallel for DeepSeek-V3.2 on AMD GPUs and add its test to nightly CI"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `test/registered/8-gpu-models/test_deepseek_v32_cp_single_node.py`, `python/sglang/srt/server_args.py`, `.github/workflows/nightly-test-amd-rocm720.yml`; technical summary: Covers "[AMD] Support context parallel for DeepSeek-V3.2 on AMD GPUs and add its test to nightly CI"; the main implementation surface is `test/registered/8-gpu-models/test_deepseek_v32_cp_single_node.py`, `python/sglang/srt/server_args.py`, `.github/workflows/nightly-test-amd-rocm720.yml`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[FIX] NSA backend page_table overflow in speculative decoding target_verify"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[FIX] NSA backend page_table overflow in speculative decoding target_verify"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[V32/GLM5] Change default setting of V32 nvfp4 on TP4"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/server_args.py`; technical summary: Covers "[V32/GLM5] Change default setting of V32 nvfp4 on TP4"; the main implementation surface is `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Add DeepSeek3.2 and GlmMoeDsa into moe tune"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `benchmark/kernels/fused_moe_triton/common_utils.py`; technical summary: Covers "Add DeepSeek3.2 and GlmMoeDsa into moe tune"; the main implementation surface is `benchmark/kernels/fused_moe_triton/common_utils.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD][Bug fix] Fix NSA context parallelism (round-robin-split) producing garbage output"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/communicator_nsa_cp.py`; technical summary: Covers "[AMD][Bug fix] Fix NSA context parallelism (round-robin-split) producing garbage output"; the main implementation surface is `python/sglang/srt/layers/communicator_nsa_cp.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[PD] Fix DeepSeek V3.2 indexer cache transfer"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/disaggregation/prefill.py`; technical summary: Covers "[PD] Fix DeepSeek V3.2 indexer cache transfer"; the main implementation surface is `python/sglang/srt/disaggregation/prefill.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix DeepSeek V32 FP4 test"; model line: DeepSeek V3.2; category: bug fix; main diff: `test/registered/quant/test_deepseek_v32_fp4_4gpu.py`, `test/registered/quant/test_deepseek_v32_fp4_mtp_4gpu.py`; technical summary: Covers "Fix DeepSeek V32 FP4 test"; the main implementation surface is `test/registered/quant/test_deepseek_v32_fp4_4gpu.py`, `test/registered/quant/test_deepseek_v32_fp4_mtp_4gpu.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Revert "Fix DeepSeek V32 FP4 test""; model line: DeepSeek V3.2; category: bug fix; main diff: `test/registered/quant/test_deepseek_v32_fp4_4gpu.py`, `test/registered/quant/test_deepseek_v32_fp4_mtp_4gpu.py`; technical summary: Covers "Revert "Fix DeepSeek V32 FP4 test""; the main implementation surface is `test/registered/quant/test_deepseek_v32_fp4_4gpu.py`, `test/registered/quant/test_deepseek_v32_fp4_mtp_4gpu.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Workaround of DSA performance drop on B200 + DP"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/server_args.py`; technical summary: Covers "Workaround of DSA performance drop on B200 + DP"; the main implementation surface is `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "FIX: (NSA) Compute topk_indices_offset when NSA prefill flashmla_sparse is used with FP8 KV cache"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "FIX: (NSA) Compute topk_indices_offset when NSA prefill flashmla_sparse is used with FP8 KV cache"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[CI] Move v32 cp test to deepep running suite"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `test/registered/cp/test_deepseek_v32_cp_single_node.py`; technical summary: Covers "[CI] Move v32 cp test to deepep running suite"; the main implementation surface is `test/registered/cp/test_deepseek_v32_cp_single_node.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DSA] Set trtllm kernels as default for Blackwell"; model line: DeepSeek V3.2; category: model implementation change; main diff: `python/sglang/srt/server_args.py`; technical summary: Covers "[DSA] Set trtllm kernels as default for Blackwell"; the main implementation surface is `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[HiSparse]: Optimize server args checking-HiSparse is temporarily only available for DSA models."; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `python/sglang/srt/server_args.py`; technical summary: Covers "[HiSparse]: Optimize server args checking-HiSparse is temporarily only available for DSA models."; the main implementation surface is `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Enable IndexCache for DeepSeek V3.2"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mla.py`, `test/registered/8-gpu-models/test_deepseek_v32_indexcache.py`; technical summary: Covers "Enable IndexCache for DeepSeek V3.2"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mla.py`, `test/registered/8-gpu-models/test_deepseek_v32_indexcache.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[HiSparse] Optimize the scheduling of decode backup."; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/managers/hisparse_coordinator.py`; technical summary: Covers "[HiSparse] Optimize the scheduling of decode backup."; the main implementation surface is `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/managers/hisparse_coordinator.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Reduce unnecessary kernels and copies in the NSA indexer"; model line: DeepSeek V3.2; category: model implementation change; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "Reduce unnecessary kernels and copies in the NSA indexer"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Fix] Fix several bugs on DSA models"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/server_args.py`; technical summary: Covers "[Fix] Fix several bugs on DSA models"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DSA] Hopper FP8 FlashMLA KV padding"; model line: DeepSeek V3.2; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `docs/basic_usage/deepseek_v32.md`, `python/sglang/srt/server_args.py`; technical summary: Covers "[DSA] Hopper FP8 FlashMLA KV padding"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `docs/basic_usage/deepseek_v32.md`, `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] Enable MTP for GLM-5-mxfp4 model"; model line: DeepSeek V3.2; category: bug fix; main diff: `python/sglang/srt/models/deepseek_nextn.py`; technical summary: Covers "[AMD] Enable MTP for GLM-5-mxfp4 model"; the main implementation surface is `python/sglang/srt/models/deepseek_nextn.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[HiCache & HybridModel] 3FS backend support DSA & mamba model"; model line: DeepSeek V3.2; category: model support/runtime entry; main diff: `python/sglang/srt/mem_cache/storage/hf3fs/storage_hf3fs.py`, `python/sglang/srt/mem_cache/storage/hf3fs/mini_3fs_metadata_server.py`, `python/sglang/srt/mem_cache/hi_mamba_radix_cache.py`; technical summary: Covers "[HiCache & HybridModel] 3FS backend support DSA & mamba model"; the main implementation surface is `python/sglang/srt/mem_cache/storage/hf3fs/storage_hf3fs.py`, `python/sglang/srt/mem_cache/storage/hf3fs/mini_3fs_metadata_server.py`, `python/sglang/srt/mem_cache/hi_mamba_radix_cache.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: `git log --name-only -- <model-files>` found it through `python/sglang/srt/hardware_backend/npu/modules/deepseek_v2_attention_mla_npu.py`, `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; associated commits `b1e1fe8eee68`; preserved from an explicit existing history/skill citation
...
- Motivation: Title: "TP indexer weight in NSA attention"; model line: DeepSeek V3.2; category: docs/tests/CI; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "TP indexer weight in NSA attention"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
