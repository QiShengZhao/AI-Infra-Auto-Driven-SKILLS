...
| … | | _另有 25 个 2026-04-24 之后的 PR 未列出_ | |
...
- 动机: 标题「fix radix cache match」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/managers/router/radix_cache.py`；未提供可用技术摘要。
...
- 动机: 标题「AMD: set weights and scaling numbers properly for block FP8」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/fp8.py`, `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/layers/quantization/fp8_utils.py`；技术摘要: 覆盖「AMD: set weights and scaling numbers properly for block FP8」；主要实现面是 `python/sglang/srt/layers/quantization/fp8.py`, `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/layers/quantization/fp8_utils.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「AMD DeepSeek_V3 FP8 Numerical fix」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「AMD DeepSeek_V3 FP8 Numerical fix」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 链接: https://github.com/sgl-project/sglang/pull/3317
- 状态/时间: merged / 2025-02-05
- 反查来源: 保留自原 history/skill 显式引用
- 代码 diff 已读范围: GitHub Pull Request files API 返回 3 个文件，+107/-11，可读 patch 265 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「Support custom mask for Triton attention」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/triton_ops/extend_attention.py`, `python/sglang/srt/layers/attention/triton_backend.py`, `test/srt/test_triton_attention_kernels.py`；技术摘要: 覆盖「Support custom mask for Triton attention」；主要实现面是 `python/sglang/srt/layers/attention/triton_ops/extend_attention.py`, `python/sglang/srt/layers/attention/triton_backend.py`, `test/srt/test_triton_attention_kernels.py`。下方保留文件级证据、代码摘录和验证风险。
- 实现要点: `python/sglang/srt/layers/attention/triton_ops/extend_attention.py` modified +48/-7 (55 lines); hunks: -49,6 +49,8 @@ def _fwd_kernel(; -71,6 +73,7 @@ def _fwd_kernel(; symbols: _fwd_kernel，涉及 `_fwd_kernel`；`python/sglang/srt/layers/attention/triton_backend.py` modified +16/-4 (20 lines); hunks: -91,6 +91,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):; -115,6 +116,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):; symbols: init_forward_metadata, init_cuda_graph_state, init_forward_metadata_capture_cuda_graph，涉及 `init_forward_metadata, init_cuda_graph_state, init_forward_metadata_capture_cuda_graph`；`test/srt/test_triton_attention_kernels.py` modified +43/-0 (43 lines); hunks: -89,6 +89,9 @@ def _test_extend_attention_once(self, B, N_CTX, H_Q, H_KV, D):; -98,6 +101,9 @@ def _test_extend_attention_once(self, B, N_CTX, H_Q, H_KV, D):; symbols: _test_extend_attention_once, test_extend_attention，涉及 `_test_extend_attention_once, test_extend_attention`。
- 代码 diff 细节:
...
- 验证与风险: diff 自带测试面 `test/srt/test_triton_attention_kernels.py`；如果继续改同一模型，优先复跑这些测试并补一个最小 launch/accuracy smoke。
...
- 动机: 标题「Feature/docs deepseek usage and add multi-node」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: 仅元数据 PR 卡片；技术摘要: GitHub 文件列表为空，本卡保留「Feature/docs deepseek usage and add multi-node」的 PR 元数据、缺失 patch 状态和验证风险，不编造文件级证据。
...
- 动机: 标题「refine deepseek_v3 launch server doc」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `benchmark/deepseek_v3/README.md`；技术摘要: 覆盖「refine deepseek_v3 launch server doc」；主要实现面是 `benchmark/deepseek_v3/README.md`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「feat: support flashinfer mla attention for deepseek v3」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「feat: support flashinfer mla attention for deepseek v3」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Support NextN (MTP) speculative decoding for DeepSeek-V3/R1」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Support NextN (MTP) speculative decoding for DeepSeek-V3/R1」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Feature DeepSeek V3/R1 INT8 Quantization (block-wise)」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Feature DeepSeek V3/R1 INT8 Quantization (block-wise)」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[ROCm] Enable Fused MLA Triton kernel for DeepSeekV3」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[ROCm] Enable Fused MLA Triton kernel for DeepSeekV3」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Feature] DeepSeek V3/R1 INT8 Quantization (channel-wise)」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[Feature] DeepSeek V3/R1 INT8 Quantization (channel-wise)」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Support nextn for flashinfer mla attention backend」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/flashinfer_mla_backend.py`, `python/sglang/srt/models/deepseek_v2.py`, `test/srt/test_mla_flashinfer.py`；技术摘要: 覆盖「Support nextn for flashinfer mla attention backend」；主要实现面是 `python/sglang/srt/layers/attention/flashinfer_mla_backend.py`, `python/sglang/srt/models/deepseek_v2.py`, `test/srt/test_mla_flashinfer.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「DeepGemm integrate to sgl-kernel」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `sgl-kernel/tests/test_deep_gemm.py`, `sgl-kernel/setup.py`, `sgl-kernel/build.sh`；技术摘要: 覆盖「DeepGemm integrate to sgl-kernel」；主要实现面是 `sgl-kernel/tests/test_deep_gemm.py`, `sgl-kernel/setup.py`, `sgl-kernel/build.sh`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「linear support deepgemm」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/test/test_block_fp8.py`, `test/srt/test_fp8_kernel.py`；技术摘要: 覆盖「linear support deepgemm」；主要实现面是 `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/test/test_block_fp8.py`, `test/srt/test_fp8_kernel.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「add INT8 example into dsv3 README」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `benchmark/deepseek_v3/README.md`；技术摘要: 覆盖「add INT8 example into dsv3 README」；主要实现面是 `benchmark/deepseek_v3/README.md`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Set deepgemm to the default value in the hopper architecture.」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/utils.py`；技术摘要: 覆盖「Set deepgemm to the default value in the hopper architecture.」；主要实现面是 `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/utils.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[ROCm] Enable MTP (NextN) on AMD GPU」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `sgl-kernel/csrc/speculative/pytorch_extension_utils_rocm.h`, `sgl-kernel/csrc/torch_extension_rocm.cc`, `python/sglang/srt/speculative/build_eagle_tree.py`；技术摘要: 覆盖「[ROCm] Enable MTP (NextN) on AMD GPU」；主要实现面是 `sgl-kernel/csrc/speculative/pytorch_extension_utils_rocm.h`, `sgl-kernel/csrc/torch_extension_rocm.cc`, `python/sglang/srt/speculative/build_eagle_tree.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Add deepseek style fused moe group gate selection kernel」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `sgl-kernel/csrc/moe/moe_fused_gate.cu`, `sgl-kernel/benchmark/bench_moe_fused_gate.py`, `sgl-kernel/tests/test_moe_fused_gate.py`；技术摘要: 覆盖「Add deepseek style fused moe group gate selection kernel」；主要实现面是 `sgl-kernel/csrc/moe/moe_fused_gate.cu`, `sgl-kernel/benchmark/bench_moe_fused_gate.py`, `sgl-kernel/tests/test_moe_fused_gate.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Add DeepSeek V3/R1 shared experts fusion」；模型线: DeepSeek V3/R1；类别: 模型支持/运行时入口；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Add DeepSeek V3/R1 shared experts fusion」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「reduce moe_align_block_size_kernel small batch mode overhead」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`, `sgl-kernel/csrc/moe/moe_align_kernel.cu`, `sgl-kernel/benchmark/bench_moe_align_block_size.py`；技术摘要: 覆盖「reduce moe_align_block_size_kernel small batch mode overhead」；主要实现面是 `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`, `sgl-kernel/csrc/moe/moe_align_kernel.cu`, `sgl-kernel/benchmark/bench_moe_align_block_size.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「fix: use deepgemm only on hopper」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`；未提供可用技术摘要。
...
- 动机: 标题「feat: use fa3 mla by default on hopper」；模型线: DeepSeek V3/R1；类别: 模型支持/运行时入口；主要 diff: `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/layers/attention/flashattention_backend.py`, `python/sglang/srt/utils.py`；技术摘要: 覆盖「feat: use fa3 mla by default on hopper」；主要实现面是 `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/layers/attention/flashattention_backend.py`, `python/sglang/srt/utils.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「apply fused moe gate in ds v3/r1」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/moe/topk.py`；技术摘要: 覆盖「apply fused moe gate in ds v3/r1」；主要实现面是 `python/sglang/srt/layers/moe/topk.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Fix] Turn off DeepGEMM by default」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`, `docs/references/deepseek.md`；技术摘要: 覆盖「[Fix] Turn off DeepGEMM by default」；主要实现面是 `python/sglang/srt/layers/quantization/fp8_kernel.py`, `docs/references/deepseek.md`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「kernel: support slightly faster merge_state_v2 cuda kernel」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `sgl-kernel/tests/test_merge_state_v2.py`, `sgl-kernel/csrc/attention/merge_attn_states.cu`, `sgl-kernel/python/sgl_kernel/attention.py`；技术摘要: 覆盖「kernel: support slightly faster merge_state_v2 cuda kernel」；主要实现面是 `sgl-kernel/tests/test_merge_state_v2.py`, `sgl-kernel/csrc/attention/merge_attn_states.cu`, `sgl-kernel/python/sgl_kernel/attention.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Refactor DeepSeek decoder layer branches」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Refactor DeepSeek decoder layer branches」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Introduce moe_dense_tp_size to fix dense layer errors in DeepSeek V3 + 4x8xH100」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Introduce moe_dense_tp_size to fix dense layer errors in DeepSeek V3 + 4x8xH100」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「enable DeepSeek V3 shared_experts_fusion in sm90」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「enable DeepSeek V3 shared_experts_fusion in sm90」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Remove extra copy in deepseek forward absorb」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/rotary_embedding.py`, `.github/workflows/pr-test-amd.yml`；技术摘要: 覆盖「Remove extra copy in deepseek forward absorb」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/rotary_embedding.py`, `.github/workflows/pr-test-amd.yml`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Turn on DeepGemm By Default and Update Doc」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/deep_gemm.py`, `docs/references/deepseek.md`；技术摘要: 覆盖「Turn on DeepGemm By Default and Update Doc」；主要实现面是 `python/sglang/srt/layers/quantization/deep_gemm.py`, `docs/references/deepseek.md`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fuse q_a_proj and kv_a_proj for DeepSeek models」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fuse q_a_proj and kv_a_proj for DeepSeek models」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[BugFix] Fix combination of MTP and `--n-share-experts-fusion`with R1」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[BugFix] Fix combination of MTP and `--n-share-experts-fusion`with R1」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「update triton 3.2.0 h200 fused moe triton config and add warning about triton fused_moe_kernel performance degradation due to different Triton versions.」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/moe/fused_moe_triton/configs/E=264,N=256,device_name=NVIDIA_H200,dtype=fp8_w8a8,block_shape=[128, 128].json`, `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`；技术摘要: 覆盖「update triton 3.2.0 h200 fused moe triton config and add warning about triton fused_moe_kernel performance degradation due to different Triton versions.」；主要实现面是 `python/sglang/srt/layers/moe/fused_moe_triton/configs/E=264,N=256,device_name=NVIDIA_H200,dtype=fp8_w8a8,block_shape=[128, 128].json`, `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Update ci test and doc for MTP api change」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `test/srt/test_mla_deepseek_v3.py`, `python/sglang/srt/server_args.py`, `docs/references/deepseek.md`；技术摘要: 覆盖「Update ci test and doc for MTP api change」；主要实现面是 `test/srt/test_mla_deepseek_v3.py`, `python/sglang/srt/server_args.py`, `docs/references/deepseek.md`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Overlap qk norm with two streams」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Overlap qk norm with two streams」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Update doc for MLA attention backends」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `docs/references/deepseek.md`, `docs/backend/server_arguments.md`；未提供可用技术摘要。
...
- 动机: 标题「Clean logs for DeepSeek-V3 launching」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Clean logs for DeepSeek-V3 launching」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[perf] dsv3 bmm fallback to bf16」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[perf] dsv3 bmm fallback to bf16」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「fix(deepseekv3): Fix DeepSeekV3Detector tool_index assignment and multi-tool call streaming support」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/function_call/deepseekv3_detector.py`；技术摘要: 覆盖「fix(deepseekv3): Fix DeepSeekV3Detector tool_index assignment and multi-tool call streaming support」；主要实现面是 `python/sglang/srt/function_call/deepseekv3_detector.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Partially supports using MHA kernels in MLA forward when page-size > 1.」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Partially supports using MHA kernels in MLA forward when page-size > 1.」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[fix][RL] Fix DeepSeekV3ForCausalLM.post_load_weights for multiple update weight」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[fix][RL] Fix DeepSeekV3ForCausalLM.post_load_weights for multiple update weight」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[DeepseekR1-FP4] Add Support for nvidia/DeepSeekR1-FP4 model」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[DeepseekR1-FP4] Add Support for nvidia/DeepSeekR1-FP4 model」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fuse routed scaling factor in deepseek」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/moe/fused_moe_triton/layer.py`；未提供可用技术摘要。
...
- 动机: 标题「Support new DeepGEMM format in per token group quant」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `sgl-kernel/csrc/gemm/per_token_group_quant_8bit.cu`, `sgl-kernel/tests/test_per_token_group_quant_8bit.py`, `sgl-kernel/include/sgl_kernel_ops.h`；未提供可用技术摘要。
...
- 动机: 标题「Support new DeepGEMM format in per token group quant (part 2: srt)」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/entrypoints/engine.py`, `python/pyproject.toml`；未提供可用技术摘要。
...
- 动机: 标题「Re-quantize DeepSeek model weights to support DeepGEMM new input format」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/fp8_utils.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/math_utils.py`；未提供可用技术摘要。
...
- 动机: 标题「Refactor DeepGEMM integration」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/deep_gemm_wrapper/compile_utils.py`, `python/sglang/srt/layers/quantization/deep_gemm_wrapper/entrypoint.py`, `python/sglang/srt/layers/moe/ep_moe/layer.py`；未提供可用技术摘要。
...
- 动机: 标题「Support new DeepGEMM」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/deep_gemm_wrapper/entrypoint.py`, `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/layers/moe/ep_moe/layer.py`；未提供可用技术摘要。
...
- 动机: 标题「[fix] fix dsv3 weight loader tqdm and simplify shared experts fusion」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[fix] fix dsv3 weight loader tqdm and simplify shared experts fusion」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[fix] fix determine_num_fused_shared_experts」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；未提供可用技术摘要。
...
- 动机: 标题「Fix Deepseek R1 0528 FP4 tensor name mismatch issue during weights loading.」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix Deepseek R1 0528 FP4 tensor name mismatch issue during weights loading.」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「fix: resolve b200 dsv3 mtp issue」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；未提供可用技术摘要。
...
- 动机: 标题「Fix judgment condition for enabling Deepseek V3/R1 shared expert fusion optimization」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix judgment condition for enabling Deepseek V3/R1 shared expert fusion optimization」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[perf] slightly imporve DeepSeek-R1-FP4 TP8」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[perf] slightly imporve DeepSeek-R1-FP4 TP8」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix MTP with Deepseek R1 Fp4」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix MTP with Deepseek R1 Fp4」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 链接: https://github.com/sgl-project/sglang/pull/7630
- 状态/时间: merged / 2025-06-29
- 反查来源: 保留自原 history/skill 显式引用
- 代码 diff 已读范围: GitHub Pull Request files API 返回 9 个文件，+800/-0，可读 patch 845 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「Add dsv3 fused a gemm to sgl-kernel」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu`, `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py`, `sgl-kernel/tests/test_dsv3_fused_a_gemm.py`；技术摘要: 覆盖「Add dsv3 fused a gemm to sgl-kernel」；主要实现面是 `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu`, `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py`, `sgl-kernel/tests/test_dsv3_fused_a_gemm.py`。下方保留文件级证据、代码摘录和验证风险。
- 实现要点: `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu` added +672/-0 (672 lines); hunks: -0,0 +1,672; symbols: Type，涉及 `Type`；`sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py` added +57/-0 (57 lines); hunks: -0,0 +1,57; symbols: benchmark, runner, tflops，涉及 `benchmark, runner, tflops`；`sgl-kernel/tests/test_dsv3_fused_a_gemm.py` added +32/-0 (32 lines); hunks: -0,0 +1,32; symbols: test_dsv3_fused_a_gemm，涉及 `test_dsv3_fused_a_gemm`；`sgl-kernel/include/utils.h` modified +17/-0 (17 lines); hunks: -241,6 +241,23 @@ inline int getSMVersion() {。
- 代码 diff 细节:
...
- 验证与风险: diff 自带测试面 `sgl-kernel/tests/test_dsv3_fused_a_gemm.py`；如果继续改同一模型，优先复跑这些测试并补一个最小 launch/accuracy smoke。
...
- 动机: 标题「Apply dsv3_fused_a_gemm kernel」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Apply dsv3_fused_a_gemm kernel」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Apply dsv3 router gemm kernel for deepseek-r1 fp4」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Apply dsv3 router gemm kernel for deepseek-r1 fp4」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「fix awq and dsv3 fused gemm compatible」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「fix awq and dsv3 fused gemm compatible」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「fix dsv3 fused proj check」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「fix dsv3 fused proj check」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[fix] fix dsv3_router_gemm filter」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[fix] fix dsv3_router_gemm filter」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「fix: disable dsv3_router_gemm in dsv3_nextn」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「fix: disable dsv3_router_gemm in dsv3_nextn」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「feat: support DeepSeek-R1-W4AFP8 model with ep-moe mode」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「feat: support DeepSeek-R1-W4AFP8 model with ep-moe mode」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix incomplete tool call capture issue in streaming response of DeepSeek-V3 when enable MTP」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/function_call/deepseekv3_detector.py`；技术摘要: 覆盖「Fix incomplete tool call capture issue in streaming response of DeepSeek-V3 when enable MTP」；主要实现面是 `python/sglang/srt/function_call/deepseekv3_detector.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Update batch size limitation of dsv3_router_gemm kernel to 16」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Update batch size limitation of dsv3_router_gemm kernel to 16」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 链接: https://github.com/sgl-project/sglang/pull/7711
- 状态/时间: closed / 2025-08-04
- 反查来源: 保留自原 history/skill 显式引用
- 代码 diff 已读范围: GitHub Pull Request files API 返回 6 个文件，+2127/-65，可读 patch 2500 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「[POC] enable trtllm fp4 from trtllm wheel」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/modelopt_quant.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/moe/fused_moe_triton/layer.py`；技术摘要: 覆盖「[POC] enable trtllm fp4 from trtllm wheel」；主要实现面是 `python/sglang/srt/layers/quantization/modelopt_quant.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/moe/fused_moe_triton/layer.py`。下方保留文件级证据、代码摘录和验证风险。
- 实现要点: `python/sglang/srt/layers/quantization/modelopt_quant.py` modified +335/-51 (386 lines); hunks: -2,7 +2,7; -29,10 +29,10; symbols: ModelOptFp4LinearMethod, __init__, create_weights, apply，涉及 `ModelOptFp4LinearMethod, __init__, create_weights`；`python/sglang/srt/models/deepseek_v2.py` modified +22/-6 (28 lines); hunks: -117,6 +117,8; -227,9 +229,10 @@ def __init__(; symbols: __init__, forward, forward_normal_dual_stream，涉及 `__init__, forward, forward_normal_dual_stream`；`python/sglang/srt/layers/moe/fused_moe_triton/layer.py` modified +17/-7 (24 lines); hunks: -19,12 +19,20; -102,10 +110,13 @@ def __init__(; symbols: __init__, weight_loader，涉及 `__init__, weight_loader`；`python/sglang/srt/layers/quantization/petit.py` modified +4/-1 (5 lines); hunks: -21,6 +21,9; -104,7 +107,7 @@ def override_quantization_method(cls, hf_quant_cfg, user_qua...; symbols: override_quantization_method, is_petit_nvfp4_compatible, is_layer_excluded，涉及 `override_quantization_method, is_petit_nvfp4_compatible, is_layer_excluded`。
- 代码 diff 细节:
...
- 验证与风险: diff 自带测试面 `test/srt/trtllm/test_trtllm_moe.py`, `test/srt/trtllm/utils.py`；如果继续改同一模型，优先复跑这些测试并补一个最小 launch/accuracy smoke。
...
- 动机: 标题「tool-call(dsv3): Improve deepseek-v3 chat template and tool_choice = `required`」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `python/sglang/srt/function_call/deepseekv3_detector.py`, `examples/chat_template/tool_chat_template_deepseekv3.jinja`；技术摘要: 覆盖「tool-call(dsv3): Improve deepseek-v3 chat template and tool_choice = `required`」；主要实现面是 `python/sglang/srt/function_call/deepseekv3_detector.py`, `examples/chat_template/tool_chat_template_deepseekv3.jinja`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Support DeepSeek-V3.1 tool call」；模型线: DeepSeek V3/R1；类别: 模型支持/运行时入口；主要 diff: `python/sglang/srt/function_call/deepseekv31_detector.py`, `examples/chat_template/tool_chat_template_deepseekv31.jinja`；技术摘要: 覆盖「Support DeepSeek-V3.1 tool call」；主要实现面是 `python/sglang/srt/function_call/deepseekv31_detector.py`, `examples/chat_template/tool_chat_template_deepseekv31.jinja`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「fix: dsv3 lite q_lora_rank none」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；未提供可用技术摘要。
...
- 动机: 标题「[feat] Support tp mode for DeepSeek-R1-W4AFP8」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[feat] Support tp mode for DeepSeek-R1-W4AFP8」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Revert "Optimized deepseek-v3/r1 model performance on mxfp4 run (#9671)"」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Revert "Optimized deepseek-v3/r1 model performance on mxfp4 run (#9671)"」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix accuracy drop of dsv3 run in dp enablement」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix accuracy drop of dsv3 run in dp enablement」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「perf: Avoid unnecessary data type conversions for DeepSeek-V3 on Blackwell」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「perf: Avoid unnecessary data type conversions for DeepSeek-V3 on Blackwell」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix run time error in dsv3-fp8 model on mi35x」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix run time error in dsv3-fp8 model on mi35x」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+1/-1，可读 patch 9 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「tool-call(dsv3): Fixed a parse problem when there are multiple function definitions in tool_calls」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `examples/chat_template/tool_chat_template_deepseekv3.jinja`；技术摘要: 覆盖「tool-call(dsv3): Fixed a parse problem when there are multiple function definitions in tool_calls」；主要实现面是 `examples/chat_template/tool_chat_template_deepseekv3.jinja`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Add DeepSeek-V3.2 Tool Call Template」；模型线: DeepSeek V3/R1；类别: 模型支持/运行时入口；主要 diff: `examples/chat_template/tool_chat_template_deepseekv32.jinja`；未提供可用技术摘要。
...
- 动机: 标题「Update DeepSeek-R1-FP4 default config on blackwell」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/server_args.py`；未提供可用技术摘要。
...
- 动机: 标题「[DSv32] Use torch.compile for _get_logits_head_gate」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`；技术摘要: 覆盖「[DSv32] Use torch.compile for _get_logits_head_gate」；主要实现面是 `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Bugfix] Fix Qwen3/DSV3/DSV3.2 model support」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[Bugfix] Fix Qwen3/DSV3/DSV3.2 model support」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Draft] Support MTP for DeepSeek-V3.2」；模型线: DeepSeek V3/R1；类别: 模型支持/运行时入口；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/srt/configs/model_config.py`；未提供可用技术摘要。
...
- 动机: 标题「[Doc] Add documentation for DeepSeek V3.2」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `docs/references/multi_node_deployment/rbg_pd/deepseekv32_pd.md`；技术摘要: 覆盖「[Doc] Add documentation for DeepSeek V3.2」；主要实现面是 `docs/references/multi_node_deployment/rbg_pd/deepseekv32_pd.md`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[doc] add example of using w4fp8 for Deepseek」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `benchmark/deepseek_v3/README.md`；技术摘要: 覆盖「[doc] add example of using w4fp8 for Deepseek」；主要实现面是 `benchmark/deepseek_v3/README.md`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Deepseek V3.2] Enable flashmla_auto with MTP」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`；技术摘要: 覆盖「[Deepseek V3.2] Enable flashmla_auto with MTP」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Update dsv3 quantization auto setting for sm100」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `python/sglang/srt/server_args.py`；技术摘要: 覆盖「Update dsv3 quantization auto setting for sm100」；主要实现面是 `python/sglang/srt/server_args.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[ROCM] Optimized deepseek-r1 model with rmsnorm + fp8 quant fusion」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[ROCM] Optimized deepseek-r1 model with rmsnorm + fp8 quant fusion」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[DeepseekV32]: use `_concat_mla_absorb_q_general` to replace `torch.cat`」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`；技术摘要: 覆盖「[DeepseekV32]: use `_concat_mla_absorb_q_general` to replace `torch.cat`」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Tool Call] Steamline function arguments when tool_choice="auto" for deepseekv31_detector」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `python/sglang/srt/function_call/deepseekv31_detector.py`；技术摘要: 覆盖「[Tool Call] Steamline function arguments when tool_choice="auto" for deepseekv31_detector」；主要实现面是 `python/sglang/srt/function_call/deepseekv31_detector.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Deepseek V3.2] Use torch.compile to speed up torch.cat in nsa」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`；技术摘要: 覆盖「[Deepseek V3.2] Use torch.compile to speed up torch.cat in nsa」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[NVIDIA] Fix broken fp8 MoE of deepseek v3」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[NVIDIA] Fix broken fp8 MoE of deepseek v3」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 反查来源: 保留自原 history/skill 显式引用
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+1/-0，可读 patch 8 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「[Fix] Fix DeepSeek V3 MTP on B200」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_nextn.py`；技术摘要: 覆盖「[Fix] Fix DeepSeek V3 MTP on B200」；主要实现面是 `python/sglang/srt/models/deepseek_nextn.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] Enable fused shared expert append and flatten quant for fp8 deepseekR1 model」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[AMD] Enable fused shared expert append and flatten quant for fp8 deepseekR1 model」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+1/-1，可读 patch 9 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「Fix Deepseek v3.1 loading issue」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix Deepseek v3.1 loading issue」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「support mtp with deepseek r1 nvfp4 model」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「support mtp with deepseek r1 nvfp4 model」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Tool Call] Fix DeepSeekV32Detector skipping functions with no params in streaming mode」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/function_call/deepseekv32_detector.py`；技术摘要: 覆盖「[Tool Call] Fix DeepSeekV32Detector skipping functions with no params in streaming mode」；主要实现面是 `python/sglang/srt/function_call/deepseekv32_detector.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+5/-1，可读 patch 13 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「[Auto Sync] Update tool_chat_template_deepseekv31.jinja (20251210)」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `examples/chat_template/tool_chat_template_deepseekv31.jinja`；技术摘要: 覆盖「[Auto Sync] Update tool_chat_template_deepseekv31.jinja (20251210)」；主要实现面是 `examples/chat_template/tool_chat_template_deepseekv31.jinja`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix dsv3 dp accuracy issue when using bf16-kv」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/aiter_backend.py`；技术摘要: 覆盖「Fix dsv3 dp accuracy issue when using bf16-kv」；主要实现面是 `python/sglang/srt/layers/attention/aiter_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[NSA] Fix NSA backend assertion error when running DeepSeek-V3.2 PP with radix-cache」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/dequant_k_cache.py`；技术摘要: 覆盖「[NSA] Fix NSA backend assertion error when running DeepSeek-V3.2 PP with radix-cache」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/dequant_k_cache.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] Support fused_rms_mxfp4_quant in the prefill stage for DeepSeek-R1-MXFP4」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[AMD] Support fused_rms_mxfp4_quant in the prefill stage for DeepSeek-R1-MXFP4」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「feat: DeepSeek-V3.2 Streaming tool call output」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/function_call/deepseekv32_detector.py`；技术摘要: 覆盖「feat: DeepSeek-V3.2 Streaming tool call output」；主要实现面是 `python/sglang/srt/function_call/deepseekv32_detector.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[perf]optimize w4afp8 kernel on deepseek-v3-0324」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/quantization/w4afp8.py`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_grouped_mm_c3x.cu`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_moe_data.cu`；技术摘要: 覆盖「[perf]optimize w4afp8 kernel on deepseek-v3-0324」；主要实现面是 `python/sglang/srt/layers/quantization/w4afp8.py`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_grouped_mm_c3x.cu`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_moe_data.cu`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Support piecewise cuda graph for dsv3 fp4」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Support piecewise cuda graph for dsv3 fp4」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Tool Call][DSV32] Streamline function call parameters」；模型线: DeepSeek V3/R1；类别: 文档/测试/CI；主要 diff: `python/sglang/srt/function_call/deepseekv32_detector.py`；技术摘要: 覆盖「[Tool Call][DSV32] Streamline function call parameters」；主要实现面是 `python/sglang/srt/function_call/deepseekv32_detector.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「feat PD: add eagle3 support for DeepSeek V3 in EP mode」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「feat PD: add eagle3 support for DeepSeek V3 in EP mode」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix DeepSeekV31's structural tag trigger」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/function_call/deepseekv31_detector.py`；技术摘要: 覆盖「Fix DeepSeekV31's structural tag trigger」；主要实现面是 `python/sglang/srt/function_call/deepseekv31_detector.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Remove deepseek-r1 from THINKING_MODE_CHOICES in run_eval.py」；模型线: DeepSeek V3/R1；类别: 模型支持/运行时入口；主要 diff: `python/sglang/test/run_eval.py`；技术摘要: 覆盖「Remove deepseek-r1 from THINKING_MODE_CHOICES in run_eval.py」；主要实现面是 `python/sglang/test/run_eval.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Use dsv3 optimized routing `fused_topk_deepseek` instead of `moe_fused_gate`」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/moe/topk.py`, `test/registered/kernels/test_fused_topk_deepseek.py`, `test/srt/test_deepseek_v3_mtp.py`；技术摘要: 覆盖「Use dsv3 optimized routing `fused_topk_deepseek` instead of `moe_fused_gate`」；主要实现面是 `python/sglang/srt/layers/moe/topk.py`, `test/registered/kernels/test_fused_topk_deepseek.py`, `test/srt/test_deepseek_v3_mtp.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[DeepSeek v3.2] Opt MTP decode cuda batch sizes and nsa implementation」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`；技术摘要: 覆盖「[DeepSeek v3.2] Opt MTP decode cuda batch sizes and nsa implementation」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] Add DeepSeek-V3.2 and VLMs model in nightly tests」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_r1_mxfp4_perf_mi35x.py`；技术摘要: 覆盖「[AMD] Add DeepSeek-V3.2 and VLMs model in nightly tests」；主要实现面是 `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_r1_mxfp4_perf_mi35x.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[OPT] DeepSeekV3.2: optimize indexer weight_proj-mma performance」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`；技术摘要: 覆盖「[OPT] DeepSeekV3.2: optimize indexer weight_proj-mma performance」；主要实现面是 `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[DeepSeek V3.2] Enable trtllm NSA with bf16 kvcache」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`；技术摘要: 覆盖「[DeepSeek V3.2] Enable trtllm NSA with bf16 kvcache」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[DeepSeek-V3.2] Fix TRT-LLM NSA in target_verify/draft_extend」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`；技术摘要: 覆盖「[DeepSeek-V3.2] Fix TRT-LLM NSA in target_verify/draft_extend」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] Add Kimi-K2, DeepSeek-V3.2 tests to nightly CI」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `test/registered/amd/accuracy/mi35x/test_deepseek_r1_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`；技术摘要: 覆盖「[AMD] Add Kimi-K2, DeepSeek-V3.2 tests to nightly CI」；主要实现面是 `test/registered/amd/accuracy/mi35x/test_deepseek_r1_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix OOM in DeepSeek weight loading by deferring dict(weights) materialization」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_common/deepseek_weight_loader.py`；技术摘要: 覆盖「Fix OOM in DeepSeek weight loading by deferring dict(weights) materialization」；主要实现面是 `python/sglang/srt/models/deepseek_common/deepseek_weight_loader.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[NPU] support dsv32 radixcache on ascend」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`；技术摘要: 覆盖「[NPU] support dsv32 radixcache on ascend」；主要实现面是 `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Tilelang sparse decode fwd for dsv32 mi355」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa/tilelang_kernel.py`；技术摘要: 覆盖「Tilelang sparse decode fwd for dsv32 mi355」；主要实现面是 `python/sglang/srt/layers/attention/nsa/tilelang_kernel.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix Bug on dsv3.2」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`；技术摘要: 覆盖「Fix Bug on dsv3.2」；主要实现面是 `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] Fix accuracy issue when running TP4 dsv3 model with mtp」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/aiter_backend.py`, `docker/rocm.Dockerfile`；技术摘要: 覆盖「[AMD] Fix accuracy issue when running TP4 dsv3 model with mtp」；主要实现面是 `python/sglang/srt/layers/attention/aiter_backend.py`, `docker/rocm.Dockerfile`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Fix model loading for DeepSeek-V3.2-AWQ」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix model loading for DeepSeek-V3.2-AWQ」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+1/-1，可读 patch 9 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「[AMD] Fix mi35x dsv32 mtp nightly」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/nsa_backend.py`；技术摘要: 覆盖「[AMD] Fix mi35x dsv32 mtp nightly」；主要实现面是 `python/sglang/srt/layers/attention/nsa_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] DSR1/V3 use fp8 bmm in MLA for MI300X」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[AMD] DSR1/V3 use fp8 bmm in MLA for MI300X」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[ROCm] Optimize Deepseek R1 on MI300X」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[ROCm] Optimize Deepseek R1 on MI300X」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] CI - Add MI35x nightly/PR tests for kv-cache-fp8 and allreduce-fusion (DeepSeek)」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_kv_fp8_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_ar_fusion_eval_mi35x.py`, `.github/workflows/nightly-test-amd-rocm720.yml`；技术摘要: 覆盖「[AMD] CI - Add MI35x nightly/PR tests for kv-cache-fp8 and allreduce-fusion (DeepSeek)」；主要实现面是 `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_kv_fp8_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_ar_fusion_eval_mi35x.py`, `.github/workflows/nightly-test-amd-rocm720.yml`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] Use bfloat16 for correction_bias in AITER FP8 path to avoid runtime dtype conversion for dsv3」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[AMD] Use bfloat16 for correction_bias in AITER FP8 path to avoid runtime dtype conversion for dsv3」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+5/-1，可读 patch 13 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「[AMD] Use aiter_dsv3_router_gemm kernel if number of experts <= 256.」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[AMD] Use aiter_dsv3_router_gemm kernel if number of experts <= 256.」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 反查来源: 保留自原 history/skill 显式引用
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+1/-1，可读 patch 9 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「Fix gpu-fault issue when run deepseek-r1 and enable dp」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/layers/attention/aiter_backend.py`；技术摘要: 覆盖「Fix gpu-fault issue when run deepseek-r1 and enable dp」；主要实现面是 `python/sglang/srt/layers/attention/aiter_backend.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[AMD] Tilelang sparse fwd for dsv32 mi355/mi300」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/layers/attention/nsa/tilelang_kernel.py`；技术摘要: 覆盖「[AMD] Tilelang sparse fwd for dsv32 mi355/mi300」；主要实现面是 `python/sglang/srt/layers/attention/nsa/tilelang_kernel.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 反查来源: 保留自原 history/skill 显式引用
- 代码 diff 已读范围: GitHub Pull Request files API 返回 1 个文件，+1/-0，可读 patch 8 行；本卡优先审计模型相关文件和高变更量文件。
- 动机: 标题「Fix aiter router GEMM regression for non-DSR1 MoE models on ROCm gfx95」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Fix aiter router GEMM regression for non-DSR1 MoE models on ROCm gfx95」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[JIT Kernel] Migrate dsv3_router_gemm from AOT sgl-kernel to JIT kernel」；模型线: DeepSeek V3/R1；类别: 模型实现调整；主要 diff: `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/glm4_moe_lite.py`, `python/sglang/jit_kernel/csrc/gemm/dsv3_router_gemm.cuh`；技术摘要: 覆盖「[JIT Kernel] Migrate dsv3_router_gemm from AOT sgl-kernel to JIT kernel」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/glm4_moe_lite.py`, `python/sglang/jit_kernel/csrc/gemm/dsv3_router_gemm.cuh`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Add dsv3 router gemm benchmark on blackwell」；模型线: DeepSeek V3/R1；类别: 性能/后端优化；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「Add dsv3 router gemm benchmark on blackwell」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Bugfix] Fix prepare_qkv_latent bypassing LoRA adapters in DeepSeek V2/V3」；模型线: DeepSeek V3/R1；类别: 缺陷修复；主要 diff: `python/sglang/srt/models/deepseek_v2.py`；技术摘要: 覆盖「[Bugfix] Fix prepare_qkv_latent bypassing LoRA adapters in DeepSeek V2/V3」；主要实现面是 `python/sglang/srt/models/deepseek_v2.py`。下方保留文件级证据、代码摘录和验证风险。
