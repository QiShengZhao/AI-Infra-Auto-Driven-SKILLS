...
| Merged | PR | Title | Tracked files touched |
| --- | --- | --- | --- |
| 2026-06-03 | [#27163](https://github.com/sgl-project/sglang/pull/27163) | [AMD] Disable AITER custom all-gather in DeepSeek-R1-MXFP4 8-GPU test | `test_deepseek_r1_mxfp4_8gpu.py` |
| 2026-06-03 | [#27001](https://github.com/sgl-project/sglang/pull/27001) | [AMD] [CI] Remove hardcoded model/cache paths from MI35x nightly tests | `test_deepseek_r1_eval_mi35x.py`, `test_deepseek_r1_mxfp4_ar_fusion_eval_mi35x.py`, `test_deepseek_r1_mxfp4_eval_mi35x.py`, … (+4) |
...
| 2026-06-01 | [#25813](https://github.com/sgl-project/sglang/pull/25813) | docs(cookbook): port popular model usage guides into cookbook pages | `DeepSeek-R1.mdx`, `DeepSeek-V3.mdx`, `DeepSeek-V3_1.mdx`, … (+1) |
...
| 2026-05-20 | [#25821](https://github.com/sgl-project/sglang/pull/25821) | [Refactor] Rename NSA → DSA: user-facing aliases, file/class/import rename | `DeepSeek-V3_2.mdx`, `deepseek-v32-deployment.jsx`, `fused_store_index_cache.cuh`, … (+24) |
...
| 2026-05-15 | [#25420](https://github.com/sgl-project/sglang/pull/25420) | [CI] Rename basic CI `stage-a/b/c` -> `base-a/b/c` for symmetry with extra CI | `test_nsa_indexer.py`, `test_nsa_pool_host_unit.py` |
...
| 2026-05-15 | [#25233](https://github.com/sgl-project/sglang/pull/25233) | [Fix] DeepSeek-V3.2: build structural tag locally to encode both wrapper and invoke layers | `deepseekv32_detector.py` |
...
| 2026-05-14 | [#25205](https://github.com/sgl-project/sglang/pull/25205) | [AMD]  Auto-fallback NSA indexer to page_size=1 when aiter preshuffle gluon kernel is unavailable (Deepseek v3.2) | `index_buf_accessor.py`, `nsa_indexer.py`, `utils.py` |
| 2026-05-13 | [#25197](https://github.com/sgl-project/sglang/pull/25197) | ci: decouple stage and runner for cuda registry | `test_nsa_indexer.py`, `test_nsa_pool_host_unit.py` |
...
| 2026-05-13 | [#24125](https://github.com/sgl-project/sglang/pull/24125) | [AMD] Skip redundant CatArrayBatchedCopy in GLM-5 NSA TileLang decode | `nsa_backend.py`, `forward_mla.py` |
| 2026-05-13 | [#23562](https://github.com/sgl-project/sglang/pull/23562) | [AMD] Enable preshuffle paged MQA and page_size=64 for NSA indexer | `index_buf_accessor.py`, `nsa_indexer.py` |
| 2026-05-13 | [#19329](https://github.com/sgl-project/sglang/pull/19329) | Bugfix: fix symm not enabled due to incorrect registration of comm | `communicator_nsa_cp.py` |
...
| 2026-05-11 | [#25014](https://github.com/sgl-project/sglang/pull/25014) | [Spec] Internal rename per N2 v2 naming rule | `nsa_backend_mtp_precompute.py`, `nsa_backend.py` |
| 2026-05-11 | [#24949](https://github.com/sgl-project/sglang/pull/24949) | Deepseek-v4-Pro share expert tp1 | `deepseek_v2.py` |
| 2026-05-11 | [#23856](https://github.com/sgl-project/sglang/pull/23856) | Use Torch `torch.mm` for Deepseek V3.2 Indexer GEMM | `nsa_indexer.py` |
...
| … | | _25 more PR(s) after 2026-04-24 omitted_ | |
...
- Git-traced PRs: 128
- Extra PRs preserved from existing docs: 113
...
| 2025-02-05 | [#3317](https://github.com/sgl-project/sglang/pull/3317) | merged | Support custom mask for Triton attention | `python/sglang/srt/layers/attention/triton_ops/extend_attention.py`, `python/sglang/srt/layers/attention/triton_backend.py`, `test/srt/test_triton_attention_kernels.py` |
...
| 2025-06-29 | [#7630](https://github.com/sgl-project/sglang/pull/7630) | merged | Add dsv3 fused a gemm to sgl-kernel | `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu`, `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py`, `sgl-kernel/tests/test_dsv3_fused_a_gemm.py` |
...
| 2025-08-04 | [#7711](https://github.com/sgl-project/sglang/pull/7711) | closed | [POC] enable trtllm fp4 from trtllm wheel | `python/sglang/srt/layers/quantization/modelopt_quant.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/moe/fused_moe_triton/layer.py` |
...
- Motivation: Title: "fix radix cache match"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/managers/router/radix_cache.py`; technical summary: Covers "fix radix cache match"; the main implementation surface is `python/sglang/srt/managers/router/radix_cache.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "AMD DeepSeek_V3 FP8 Numerical fix"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "AMD DeepSeek_V3 FP8 Numerical fix"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
### PR #3317 - Support custom mask for Triton attention

- Link: https://github.com/sgl-project/sglang/pull/3317
- Status/date: merged / 2025-02-05
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 3 files, +107/-11, 265 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Support custom mask for Triton attention"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/triton_ops/extend_attention.py`, `python/sglang/srt/layers/attention/triton_backend.py`, `test/srt/test_triton_attention_kernels.py`; technical summary: Covers "Support custom mask for Triton attention"; the main implementation surface is `python/sglang/srt/layers/attention/triton_ops/extend_attention.py`, `python/sglang/srt/layers/attention/triton_backend.py`, `test/srt/test_triton_attention_kernels.py`. File-level evidence, code excerpts, and validation risks are preserved below.
- Key implementation: `python/sglang/srt/layers/attention/triton_ops/extend_attention.py` modified +48/-7 (55 lines); hunks: -49,6 +49,8 @@ def _fwd_kernel(; -71,6 +73,7 @@ def _fwd_kernel(; symbols: _fwd_kernel, touching `_fwd_kernel`; `python/sglang/srt/layers/attention/triton_backend.py` modified +16/-4 (20 lines); hunks: -91,6 +91,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):; -115,6 +116,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):; symbols: init_forward_metadata, init_cuda_graph_state, init_forward_metadata_capture_cuda_graph, touching `init_forward_metadata, init_cuda_graph_state, init_forward_metadata_capture_cuda_graph`; `test/srt/test_triton_attention_kernels.py` modified +43/-0 (43 lines); hunks: -89,6 +89,9 @@ def _test_extend_attention_once(self, B, N_CTX, H_Q, H_KV, D):; -98,6 +101,9 @@ def _test_extend_attention_once(self, B, N_CTX, H_Q, H_KV, D):; symbols: _test_extend_attention_once, test_extend_attention, touching `_test_extend_attention_once, test_extend_attention`.
- Code diff details:
  - `python/sglang/srt/layers/attention/triton_ops/extend_attention.py` modified +48/-7 (55 lines); hunks: -49,6 +49,8 @@ def _fwd_kernel(; -71,6 +73,7 @@ def _fwd_kernel(; symbols: _fwd_kernel
  - `python/sglang/srt/layers/attention/triton_backend.py` modified +16/-4 (20 lines); hunks: -91,6 +91,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):; -115,6 +116,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):; symbols: init_forward_metadata, init_cuda_graph_state, init_forward_metadata_capture_cuda_graph
  - `test/srt/test_triton_attention_kernels.py` modified +43/-0 (43 lines); hunks: -89,6 +89,9 @@ def _test_extend_attention_once(self, B, N_CTX, H_Q, H_KV, D):; -98,6 +101,9 @@ def _test_extend_attention_once(self, B, N_CTX, H_Q, H_KV, D):; symbols: _test_extend_attention_once, test_extend_attention
- Key code excerpts:
...
@@ -91,6 +91,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):
+            mask_offsets = None
@@ -115,6 +116,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):
+            mask_offsets = None
@@ -126,6 +128,7 @@ def init_forward_metadata(self, forward_batch: ForwardBatch):
+            mask_offsets,
@@ -180,6 +183,7 @@ def init_forward_metadata_capture_cuda_graph(
diff -- test/srt/test_triton_attention_kernels.py
@@ -89,6 +89,9 @@ def _test_extend_attention_once(self, B, N_CTX, H_Q, H_KV, D):
```

- Reviewed files:
  - runtime: `python/sglang/srt/layers/attention/triton_ops/extend_attention.py` modified +48/-7; `python/sglang/srt/layers/attention/triton_backend.py` modified +16/-4
  - tests: `test/srt/test_triton_attention_kernels.py` modified +43/-0
- Risk and verification: The diff ships test coverage in `test/srt/test_triton_attention_kernels.py`; future changes in this area should rerun those tests plus a minimal launch or accuracy smoke.
...
- Motivation: Title: "Feature/docs deepseek usage and add multi-node"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: metadata-only PR card; technical summary: GitHub returned an empty changed-file list for "Feature/docs deepseek usage and add multi-node"; this card records PR metadata, the missing-patch state, and validation risks without inventing file evidence.
...
- Motivation: Title: "refine deepseek_v3 launch server doc"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `benchmark/deepseek_v3/README.md`; technical summary: Covers "refine deepseek_v3 launch server doc"; the main implementation surface is `benchmark/deepseek_v3/README.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Refactor flashinfer logic for deepseek v3 and fix accuracy bug"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Refactor flashinfer logic for deepseek v3 and fix accuracy bug"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Support nextn for flashinfer mla attention backend"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/flashinfer_mla_backend.py`, `python/sglang/srt/models/deepseek_v2.py`, `test/srt/test_mla_flashinfer.py`; technical summary: Covers "Support nextn for flashinfer mla attention backend"; the main implementation surface is `python/sglang/srt/layers/attention/flashinfer_mla_backend.py`, `python/sglang/srt/models/deepseek_v2.py`, `test/srt/test_mla_flashinfer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "DeepGemm integrate to sgl-kernel"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `sgl-kernel/tests/test_deep_gemm.py`, `sgl-kernel/setup.py`, `sgl-kernel/build.sh`; technical summary: Covers "DeepGemm integrate to sgl-kernel"; the main implementation surface is `sgl-kernel/tests/test_deep_gemm.py`, `sgl-kernel/setup.py`, `sgl-kernel/build.sh`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "linear support deepgemm"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/test/test_block_fp8.py`, `test/srt/test_fp8_kernel.py`; technical summary: Covers "linear support deepgemm"; the main implementation surface is `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/test/test_block_fp8.py`, `test/srt/test_fp8_kernel.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "add INT8 example into dsv3 README"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `benchmark/deepseek_v3/README.md`; technical summary: Covers "add INT8 example into dsv3 README"; the main implementation surface is `benchmark/deepseek_v3/README.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[ROCm] Enable MTP (NextN) on AMD GPU"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `sgl-kernel/csrc/speculative/pytorch_extension_utils_rocm.h`, `sgl-kernel/csrc/torch_extension_rocm.cc`, `python/sglang/srt/speculative/build_eagle_tree.py`; technical summary: Covers "[ROCm] Enable MTP (NextN) on AMD GPU"; the main implementation surface is `sgl-kernel/csrc/speculative/pytorch_extension_utils_rocm.h`, `sgl-kernel/csrc/torch_extension_rocm.cc`, `python/sglang/srt/speculative/build_eagle_tree.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Add deepseek style fused moe group gate selection kernel"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `sgl-kernel/csrc/moe/moe_fused_gate.cu`, `sgl-kernel/benchmark/bench_moe_fused_gate.py`, `sgl-kernel/tests/test_moe_fused_gate.py`; technical summary: Covers "Add deepseek style fused moe group gate selection kernel"; the main implementation surface is `sgl-kernel/csrc/moe/moe_fused_gate.cu`, `sgl-kernel/benchmark/bench_moe_fused_gate.py`, `sgl-kernel/tests/test_moe_fused_gate.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Add DeepSeek V3/R1 shared experts fusion"; model line: DeepSeek V3/R1; category: model support/runtime entry; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Add DeepSeek V3/R1 shared experts fusion"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix DeepSeek error when using DeepEP mode"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix DeepSeek error when using DeepEP mode"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "reduce moe_align_block_size_kernel small batch mode overhead"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`, `sgl-kernel/csrc/moe/moe_align_kernel.cu`, `sgl-kernel/benchmark/bench_moe_align_block_size.py`; technical summary: Covers "reduce moe_align_block_size_kernel small batch mode overhead"; the main implementation surface is `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`, `sgl-kernel/csrc/moe/moe_align_kernel.cu`, `sgl-kernel/benchmark/bench_moe_align_block_size.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix: use deepgemm only on hopper"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`; technical summary: Covers "fix: use deepgemm only on hopper"; the main implementation surface is `python/sglang/srt/layers/quantization/fp8_kernel.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Fix] Turn off DeepGEMM by default"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`, `docs/references/deepseek.md`; technical summary: Covers "[Fix] Turn off DeepGEMM by default"; the main implementation surface is `python/sglang/srt/layers/quantization/fp8_kernel.py`, `docs/references/deepseek.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "kernel: support slightly faster merge_state_v2 cuda kernel"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `sgl-kernel/tests/test_merge_state_v2.py`, `sgl-kernel/csrc/attention/merge_attn_states.cu`, `sgl-kernel/python/sgl_kernel/attention.py`; technical summary: Covers "kernel: support slightly faster merge_state_v2 cuda kernel"; the main implementation surface is `sgl-kernel/tests/test_merge_state_v2.py`, `sgl-kernel/csrc/attention/merge_attn_states.cu`, `sgl-kernel/python/sgl_kernel/attention.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Refactor DeepSeek decoder layer branches"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Refactor DeepSeek decoder layer branches"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Introduce moe_dense_tp_size to fix dense layer errors in DeepSeek V3 + 4x8xH100"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Introduce moe_dense_tp_size to fix dense layer errors in DeepSeek V3 + 4x8xH100"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Remove extra copy in deepseek forward absorb"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/rotary_embedding.py`, `.github/workflows/pr-test-amd.yml`; technical summary: Covers "Remove extra copy in deepseek forward absorb"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/rotary_embedding.py`, `.github/workflows/pr-test-amd.yml`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Turn on DeepGemm By Default and Update Doc"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/quantization/deep_gemm.py`, `docs/references/deepseek.md`; technical summary: Covers "Turn on DeepGemm By Default and Update Doc"; the main implementation surface is `python/sglang/srt/layers/quantization/deep_gemm.py`, `docs/references/deepseek.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[BugFix] Fix combination of MTP and `--n-share-experts-fusion`with R1"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[BugFix] Fix combination of MTP and `--n-share-experts-fusion`with R1"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "update triton 3.2.0 h200 fused moe triton config and add warning about triton fused_moe_kernel performance degradation due to different Triton versions."; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/moe/fused_moe_triton/configs/E=264,N=256,device_name=NVIDIA_H200,dtype=fp8_w8a8,block_shape=[128, 128].json`, `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`; technical summary: Covers "update triton 3.2.0 h200 fused moe triton config and add warning about triton fused_moe_kernel performance degradation due to different Triton versions."; the main implementation surface is `python/sglang/srt/layers/moe/fused_moe_triton/configs/E=264,N=256,device_name=NVIDIA_H200,dtype=fp8_w8a8,block_shape=[128, 128].json`, `python/sglang/srt/layers/moe/fused_moe_triton/fused_moe.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Update ci test and doc for MTP api change"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `test/srt/test_mla_deepseek_v3.py`, `python/sglang/srt/server_args.py`, `docs/references/deepseek.md`; technical summary: Covers "Update ci test and doc for MTP api change"; the main implementation surface is `test/srt/test_mla_deepseek_v3.py`, `python/sglang/srt/server_args.py`, `docs/references/deepseek.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "feat: Refactor DeepSeekV3 function call"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `examples/chat_template/tool_chat_template_deepseekv3.jinja`; technical summary: Covers "feat: Refactor DeepSeekV3 function call"; the main implementation surface is `examples/chat_template/tool_chat_template_deepseekv3.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Update doc for MLA attention backends"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `docs/references/deepseek.md`, `docs/backend/server_arguments.md`; technical summary: Covers "Update doc for MLA attention backends"; the main implementation surface is `docs/references/deepseek.md`, `docs/backend/server_arguments.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Clean logs for DeepSeek-V3 launching"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Clean logs for DeepSeek-V3 launching"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[perf] dsv3 bmm fallback to bf16"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[perf] dsv3 bmm fallback to bf16"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix(deepseekv3): Fix DeepSeekV3Detector tool_index assignment and multi-tool call streaming support"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/function_call/deepseekv3_detector.py`; technical summary: Covers "fix(deepseekv3): Fix DeepSeekV3Detector tool_index assignment and multi-tool call streaming support"; the main implementation surface is `python/sglang/srt/function_call/deepseekv3_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Partially supports using MHA kernels in MLA forward when page-size > 1."; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Partially supports using MHA kernels in MLA forward when page-size > 1."; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[fix][RL] Fix DeepSeekV3ForCausalLM.post_load_weights for multiple update weight"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[fix][RL] Fix DeepSeekV3ForCausalLM.post_load_weights for multiple update weight"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Support new DeepGEMM format in per token group quant"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `sgl-kernel/csrc/gemm/per_token_group_quant_8bit.cu`, `sgl-kernel/tests/test_per_token_group_quant_8bit.py`, `sgl-kernel/include/sgl_kernel_ops.h`; technical summary: Covers "Support new DeepGEMM format in per token group quant"; the main implementation surface is `sgl-kernel/csrc/gemm/per_token_group_quant_8bit.cu`, `sgl-kernel/tests/test_per_token_group_quant_8bit.py`, `sgl-kernel/include/sgl_kernel_ops.h`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Support new DeepGEMM format in per token group quant (part 2: srt)"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/entrypoints/engine.py`, `python/pyproject.toml`; technical summary: Covers "Support new DeepGEMM format in per token group quant (part 2: srt)"; the main implementation surface is `python/sglang/srt/layers/quantization/fp8_kernel.py`, `python/sglang/srt/entrypoints/engine.py`, `python/pyproject.toml`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Re-quantize DeepSeek model weights to support DeepGEMM new input format"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/quantization/fp8_utils.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/math_utils.py`; technical summary: Covers "Re-quantize DeepSeek model weights to support DeepGEMM new input format"; the main implementation surface is `python/sglang/srt/layers/quantization/fp8_utils.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/math_utils.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[fix] fix dsv3 weight loader tqdm and simplify shared experts fusion"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[fix] fix dsv3 weight loader tqdm and simplify shared experts fusion"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[fix] fix determine_num_fused_shared_experts"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[fix] fix determine_num_fused_shared_experts"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix Deepseek R1 0528 FP4 tensor name mismatch issue during weights loading."; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix Deepseek R1 0528 FP4 tensor name mismatch issue during weights loading."; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix: resolve b200 dsv3 mtp issue"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "fix: resolve b200 dsv3 mtp issue"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix judgment condition for enabling Deepseek V3/R1 shared expert fusion optimization"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix judgment condition for enabling Deepseek V3/R1 shared expert fusion optimization"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[perf] slightly imporve DeepSeek-R1-FP4 TP8"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[perf] slightly imporve DeepSeek-R1-FP4 TP8"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix MTP with Deepseek R1 Fp4"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix MTP with Deepseek R1 Fp4"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
### PR #7630 - Add dsv3 fused a gemm to sgl-kernel

- Link: https://github.com/sgl-project/sglang/pull/7630
- Status/date: merged / 2025-06-29
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 9 files, +800/-0, 845 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Add dsv3 fused a gemm to sgl-kernel"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu`, `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py`, `sgl-kernel/tests/test_dsv3_fused_a_gemm.py`; technical summary: Covers "Add dsv3 fused a gemm to sgl-kernel"; the main implementation surface is `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu`, `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py`, `sgl-kernel/tests/test_dsv3_fused_a_gemm.py`. File-level evidence, code excerpts, and validation risks are preserved below.
- Key implementation: `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu` added +672/-0 (672 lines); hunks: -0,0 +1,672; symbols: Type, touching `Type`; `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py` added +57/-0 (57 lines); hunks: -0,0 +1,57; symbols: benchmark, runner, tflops, touching `benchmark, runner, tflops`; `sgl-kernel/tests/test_dsv3_fused_a_gemm.py` added +32/-0 (32 lines); hunks: -0,0 +1,32; symbols: test_dsv3_fused_a_gemm, touching `test_dsv3_fused_a_gemm`; `sgl-kernel/include/utils.h` modified +17/-0 (17 lines); hunks: -241,6 +241,23 @@ inline int getSMVersion() {.
- Code diff details:
  - `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu` added +672/-0 (672 lines); hunks: -0,0 +1,672; symbols: Type
  - `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py` added +57/-0 (57 lines); hunks: -0,0 +1,57; symbols: benchmark, runner, tflops
  - `sgl-kernel/tests/test_dsv3_fused_a_gemm.py` added +32/-0 (32 lines); hunks: -0,0 +1,32; symbols: test_dsv3_fused_a_gemm
  - `sgl-kernel/include/utils.h` modified +17/-0 (17 lines); hunks: -241,6 +241,23 @@ inline int getSMVersion() {
  - `sgl-kernel/python/sgl_kernel/gemm.py` modified +15/-0 (15 lines); hunks: -82,6 +82,21 @@ def bmm_fp8(; symbols: bmm_fp8, dsv3_fused_a_gemm, sgl_per_token_group_quant_fp8
- Key code excerpts:

```diff
diff -- sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu
@@ -0,0 +1,672 @@
+/*
+ * Adapted from
...
diff -- sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py
@@ -0,0 +1,57 @@
+import argparse
+import torch
...
diff -- sgl-kernel/tests/test_dsv3_fused_a_gemm.py
@@ -0,0 +1,32 @@
```

- Reviewed files:
  - other: `sgl-kernel/csrc/gemm/dsv3_fused_a_gemm.cu` added +672/-0; `sgl-kernel/benchmark/bench_dsv3_fused_a_gemm.py` added +57/-0; `sgl-kernel/include/utils.h` modified +17/-0; `sgl-kernel/python/sgl_kernel/gemm.py` modified +15/-0; `sgl-kernel/csrc/common_extension.cc` modified +3/-0; `sgl-kernel/include/sgl_kernel_ops.h` modified +2/-0
  - tests: `sgl-kernel/tests/test_dsv3_fused_a_gemm.py` added +32/-0
- Risk and verification: The diff ships test coverage in `sgl-kernel/tests/test_dsv3_fused_a_gemm.py`; future changes in this area should rerun those tests plus a minimal launch or accuracy smoke.
...
- Motivation: Title: "Apply dsv3_fused_a_gemm kernel"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Apply dsv3_fused_a_gemm kernel"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Apply dsv3 router gemm kernel for deepseek-r1 fp4"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Apply dsv3 router gemm kernel for deepseek-r1 fp4"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix awq and dsv3 fused gemm compatible"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "fix awq and dsv3 fused gemm compatible"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix dsv3 fused proj check"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "fix dsv3 fused proj check"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[fix] fix dsv3_router_gemm filter"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[fix] fix dsv3_router_gemm filter"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix: disable dsv3_router_gemm in dsv3_nextn"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "fix: disable dsv3_router_gemm in dsv3_nextn"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix incomplete tool call capture issue in streaming response of DeepSeek-V3 when enable MTP"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/function_call/deepseekv3_detector.py`; technical summary: Covers "Fix incomplete tool call capture issue in streaming response of DeepSeek-V3 when enable MTP"; the main implementation surface is `python/sglang/srt/function_call/deepseekv3_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Update batch size limitation of dsv3_router_gemm kernel to 16"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Update batch size limitation of dsv3_router_gemm kernel to 16"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
### PR #7711 - [POC] enable trtllm fp4 from trtllm wheel

- Link: https://github.com/sgl-project/sglang/pull/7711
- Status/date: closed / 2025-08-04
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 6 files, +2127/-65, 2500 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[POC] enable trtllm fp4 from trtllm wheel"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/quantization/modelopt_quant.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/moe/fused_moe_triton/layer.py`; technical summary: Covers "[POC] enable trtllm fp4 from trtllm wheel"; the main implementation surface is `python/sglang/srt/layers/quantization/modelopt_quant.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/layers/moe/fused_moe_triton/layer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
- Key implementation: `python/sglang/srt/layers/quantization/modelopt_quant.py` modified +335/-51 (386 lines); hunks: -2,7 +2,7; -29,10 +29,10; symbols: ModelOptFp4LinearMethod, __init__, create_weights, apply, touching `ModelOptFp4LinearMethod, __init__, create_weights`; `python/sglang/srt/models/deepseek_v2.py` modified +22/-6 (28 lines); hunks: -117,6 +117,8; -227,9 +229,10 @@ def __init__(; symbols: __init__, forward, forward_normal_dual_stream, touching `__init__, forward, forward_normal_dual_stream`; `python/sglang/srt/layers/moe/fused_moe_triton/layer.py` modified +17/-7 (24 lines); hunks: -19,12 +19,20; -102,10 +110,13 @@ def __init__(; symbols: __init__, weight_loader, touching `__init__, weight_loader`; `python/sglang/srt/layers/quantization/petit.py` modified +4/-1 (5 lines); hunks: -21,6 +21,9; -104,7 +107,7 @@ def override_quantization_method(cls, hf_quant_cfg, user_qua...; symbols: override_quantization_method, is_petit_nvfp4_compatible, is_layer_excluded, touching `override_quantization_method, is_petit_nvfp4_compatible, is_layer_excluded`.
- Code diff details:
  - `python/sglang/srt/layers/quantization/modelopt_quant.py` modified +335/-51 (386 lines); hunks: -2,7 +2,7; -29,10 +29,10; symbols: ModelOptFp4LinearMethod, __init__, create_weights, apply
  - `python/sglang/srt/models/deepseek_v2.py` modified +22/-6 (28 lines); hunks: -117,6 +117,8; -227,9 +229,10 @@ def __init__(; symbols: __init__, forward, forward_normal_dual_stream
  - `python/sglang/srt/layers/moe/fused_moe_triton/layer.py` modified +17/-7 (24 lines); hunks: -19,12 +19,20; -102,10 +110,13 @@ def __init__(; symbols: __init__, weight_loader
  - `python/sglang/srt/layers/quantization/petit.py` modified +4/-1 (5 lines); hunks: -21,6 +21,9; -104,7 +107,7 @@ def override_quantization_method(cls, hf_quant_cfg, user_qua...; symbols: override_quantization_method, is_petit_nvfp4_compatible, is_layer_excluded
  - `test/srt/trtllm/test_trtllm_moe.py` added +1341/-0 (1341 lines); hunks: -0,0 +1,1341; symbols: moe_args, __init__, moe_args_dequant, routing_reference
- Key code excerpts:
...
@@ -246,6 +249,11 @@ def forward(self, hidden_states):
diff -- python/sglang/srt/layers/moe/fused_moe_triton/layer.py
@@ -19,12 +19,20 @@
```

- Reviewed files:
  - runtime: `python/sglang/srt/layers/quantization/modelopt_quant.py` modified +335/-51; `python/sglang/srt/models/deepseek_v2.py` modified +22/-6; `python/sglang/srt/layers/moe/fused_moe_triton/layer.py` modified +17/-7; `python/sglang/srt/layers/quantization/petit.py` modified +4/-1
  - tests: `test/srt/trtllm/test_trtllm_moe.py` added +1341/-0; `test/srt/trtllm/utils.py` added +408/-0
- Risk and verification: The diff ships test coverage in `test/srt/trtllm/test_trtllm_moe.py`, `test/srt/trtllm/utils.py`; future changes in this area should rerun those tests plus a minimal launch or accuracy smoke.
...
- Motivation: Title: "tool-call(dsv3): Improve deepseek-v3 chat template and tool_choice = `required`"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `python/sglang/srt/function_call/deepseekv3_detector.py`, `examples/chat_template/tool_chat_template_deepseekv3.jinja`; technical summary: Covers "tool-call(dsv3): Improve deepseek-v3 chat template and tool_choice = `required`"; the main implementation surface is `python/sglang/srt/function_call/deepseekv3_detector.py`, `examples/chat_template/tool_chat_template_deepseekv3.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Support DeepSeek-V3.1 tool call"; model line: DeepSeek V3/R1; category: model support/runtime entry; main diff: `python/sglang/srt/function_call/deepseekv31_detector.py`, `examples/chat_template/tool_chat_template_deepseekv31.jinja`; technical summary: Covers "Support DeepSeek-V3.1 tool call"; the main implementation surface is `python/sglang/srt/function_call/deepseekv31_detector.py`, `examples/chat_template/tool_chat_template_deepseekv31.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "fix: dsv3 lite q_lora_rank none"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "fix: dsv3 lite q_lora_rank none"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Update tool_chat_template_deepseekv31.jinja"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `examples/chat_template/tool_chat_template_deepseekv31.jinja`; technical summary: Covers "Update tool_chat_template_deepseekv31.jinja"; the main implementation surface is `examples/chat_template/tool_chat_template_deepseekv31.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix accuracy drop of dsv3 run in dp enablement"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix accuracy drop of dsv3 run in dp enablement"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix run time error in dsv3-fp8 model on mi35x"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix run time error in dsv3-fp8 model on mi35x"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "tool-call(dsv3): Fixed a parse problem when there are multiple function definitions in tool_calls"; model line: DeepSeek V3/R1; category: bug fix; main diff: `examples/chat_template/tool_chat_template_deepseekv3.jinja`; technical summary: Covers "tool-call(dsv3): Fixed a parse problem when there are multiple function definitions in tool_calls"; the main implementation surface is `examples/chat_template/tool_chat_template_deepseekv3.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix GPU fault issue when run dsv3 with dp mode and enable torch-compile"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/dp_attention.py`, `python/sglang/srt/layers/logits_processor.py`; technical summary: Covers "Fix GPU fault issue when run dsv3 with dp mode and enable torch-compile"; the main implementation surface is `python/sglang/srt/layers/dp_attention.py`, `python/sglang/srt/layers/logits_processor.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Add DeepSeek-V3.2 Tool Call Template"; model line: DeepSeek V3/R1; category: model support/runtime entry; main diff: `examples/chat_template/tool_chat_template_deepseekv32.jinja`; technical summary: Covers "Add DeepSeek-V3.2 Tool Call Template"; the main implementation surface is `examples/chat_template/tool_chat_template_deepseekv32.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Bugfix] Fix Qwen3/DSV3/DSV3.2 model support"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[Bugfix] Fix Qwen3/DSV3/DSV3.2 model support"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Draft] Support MTP for DeepSeek-V3.2"; model line: DeepSeek V3/R1; category: model support/runtime entry; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/srt/configs/model_config.py`; technical summary: Covers "[Draft] Support MTP for DeepSeek-V3.2"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/srt/configs/model_config.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[2/N]Support DeepSeek-R1 w4a8 low latency deepep"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/moe/ep_moe/kernels.py`, `python/sglang/srt/layers/moe/cutlass_w4a8_moe.py`, `python/sglang/srt/layers/quantization/w4afp8.py`; technical summary: Covers "[2/N]Support DeepSeek-R1 w4a8 low latency deepep"; the main implementation surface is `python/sglang/srt/layers/moe/ep_moe/kernels.py`, `python/sglang/srt/layers/moe/cutlass_w4a8_moe.py`, `python/sglang/srt/layers/quantization/w4afp8.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[doc] add example of using w4fp8 for Deepseek"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `benchmark/deepseek_v3/README.md`; technical summary: Covers "[doc] add example of using w4fp8 for Deepseek"; the main implementation surface is `benchmark/deepseek_v3/README.md`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepseekV32] Enable flashmla_prefill kernel with fp8 kvcache"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/dequant_k_cache.py`, `python/sglang/srt/layers/attention/nsa/quant_k_cache.py`; technical summary: Covers "[DeepseekV32] Enable flashmla_prefill kernel with fp8 kvcache"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/dequant_k_cache.py`, `python/sglang/srt/layers/attention/nsa/quant_k_cache.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[2/2] Deepseek deterministic: support deepseek v3 deterministic inference on 8 x H200"; model line: DeepSeek V3/R1; category: model support/runtime entry; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[2/2] Deepseek deterministic: support deepseek v3 deterministic inference on 8 x H200"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Update dsv3 quantization auto setting for sm100"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/server_args.py`; technical summary: Covers "Update dsv3 quantization auto setting for sm100"; the main implementation surface is `python/sglang/srt/server_args.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[sgl-kernel][Deepseek V3.2] Add row_starts to topk kernel"; model line: DeepSeek V3/R1; category: bug fix; main diff: `sgl-kernel/tests/test_topk.py`, `sgl-kernel/csrc/elementwise/topk.cu`, `sgl-kernel/python/sgl_kernel/top_k.py`; technical summary: Covers "[sgl-kernel][Deepseek V3.2] Add row_starts to topk kernel"; the main implementation surface is `sgl-kernel/tests/test_topk.py`, `sgl-kernel/csrc/elementwise/topk.cu`, `sgl-kernel/python/sgl_kernel/top_k.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepseekV32]: use `_concat_mla_absorb_q_general` to replace `torch.cat`"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[DeepseekV32]: use `_concat_mla_absorb_q_general` to replace `torch.cat`"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Tool Call] Steamline function arguments when tool_choice="auto" for deepseekv31_detector"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/function_call/deepseekv31_detector.py`; technical summary: Covers "[Tool Call] Steamline function arguments when tool_choice="auto" for deepseekv31_detector"; the main implementation surface is `python/sglang/srt/function_call/deepseekv31_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Deepseek V3.2] Use torch.compile to speed up torch.cat in nsa"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[Deepseek V3.2] Use torch.compile to speed up torch.cat in nsa"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[NVIDIA] Fix broken fp8 MoE of deepseek v3"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[NVIDIA] Fix broken fp8 MoE of deepseek v3"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-0, 8 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[Fix] Fix DeepSeek V3 MTP on B200"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_nextn.py`; technical summary: Covers "[Fix] Fix DeepSeek V3 MTP on B200"; the main implementation surface is `python/sglang/srt/models/deepseek_nextn.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[ROCM] Optimized deepseek-r1 fp8 model with + triton_gemm_a8w8 + batch_gemm_a8w8 + fused set_mla_kv_buffer kernel"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[ROCM] Optimized deepseek-r1 fp8 model with + triton_gemm_a8w8 + batch_gemm_a8w8 + fused set_mla_kv_buffer kernel"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Fix Deepseek v3.1 loading issue"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix Deepseek v3.1 loading issue"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "support mtp with deepseek r1 nvfp4 model"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "support mtp with deepseek r1 nvfp4 model"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Tool Call] Fix DeepSeekV32Detector skipping functions with no params in streaming mode"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "[Tool Call] Fix DeepSeekV32Detector skipping functions with no params in streaming mode"; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +5/-1, 13 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[Auto Sync] Update tool_chat_template_deepseekv31.jinja (20251210)"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `examples/chat_template/tool_chat_template_deepseekv31.jinja`; technical summary: Covers "[Auto Sync] Update tool_chat_template_deepseekv31.jinja (20251210)"; the main implementation surface is `examples/chat_template/tool_chat_template_deepseekv31.jinja`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[NPU]dsv3.2 cp for npu"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/srt/layers/attention/nsa/utils.py`, `python/sglang/srt/layers/communicator_nsa_cp.py`; technical summary: Covers "[NPU]dsv3.2 cp for npu"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/srt/layers/attention/nsa/utils.py`, `python/sglang/srt/layers/communicator_nsa_cp.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix dsv3 dp accuracy issue when using bf16-kv"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/aiter_backend.py`; technical summary: Covers "Fix dsv3 dp accuracy issue when using bf16-kv"; the main implementation surface is `python/sglang/srt/layers/attention/aiter_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[NSA] Fix NSA backend assertion error when running DeepSeek-V3.2 PP with radix-cache"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/dequant_k_cache.py`; technical summary: Covers "[NSA] Fix NSA backend assertion error when running DeepSeek-V3.2 PP with radix-cache"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/layers/attention/nsa/dequant_k_cache.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "feat: DeepSeek-V3.2 Streaming tool call output"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "feat: DeepSeek-V3.2 Streaming tool call output"; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Performance] sgl-kernel, optimize group gemm in DeepSeek-R1-W4AFP8 w4a8 moe"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_grouped_mm_c3x.cu`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/scaled_mm_entry.cu`, `sgl-kernel/python/sgl_kernel/cutlass_moe.py`; technical summary: Covers "[Performance] sgl-kernel, optimize group gemm in DeepSeek-R1-W4AFP8 w4a8 moe"; the main implementation surface is `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_grouped_mm_c3x.cu`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/scaled_mm_entry.cu`, `sgl-kernel/python/sgl_kernel/cutlass_moe.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[perf]optimize w4afp8 kernel on deepseek-v3-0324"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/quantization/w4afp8.py`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_grouped_mm_c3x.cu`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_moe_data.cu`; technical summary: Covers "[perf]optimize w4afp8 kernel on deepseek-v3-0324"; the main implementation surface is `python/sglang/srt/layers/quantization/w4afp8.py`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_grouped_mm_c3x.cu`, `sgl-kernel/csrc/moe/cutlass_moe/w4a8/w4a8_moe_data.cu`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[Deepseek V3.2] Fix Deepseek MTP in V1 mode"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[Deepseek V3.2] Fix Deepseek MTP in V1 mode"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Support piecewise cuda graph for dsv3 fp4"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Support piecewise cuda graph for dsv3 fp4"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Tool Call][DSV32] Streamline function call parameters"; model line: DeepSeek V3/R1; category: docs/tests/CI; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "[Tool Call][DSV32] Streamline function call parameters"; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix DeepSeekV31's structural tag trigger"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/function_call/deepseekv31_detector.py`; technical summary: Covers "Fix DeepSeekV31's structural tag trigger"; the main implementation surface is `python/sglang/srt/function_call/deepseekv31_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepSeek v3.2] Opt MTP decode cuda batch sizes and nsa implementation"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[DeepSeek v3.2] Opt MTP decode cuda batch sizes and nsa implementation"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] Add DeepSeek-V3.2 and VLMs model in nightly tests"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_r1_mxfp4_perf_mi35x.py`; technical summary: Covers "[AMD] Add DeepSeek-V3.2 and VLMs model in nightly tests"; the main implementation surface is `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`, `test/registered/amd/perf/mi35x/test_deepseek_r1_mxfp4_perf_mi35x.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepSeek-V3.2] Fix TRT-LLM NSA in target_verify/draft_extend"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[DeepSeek-V3.2] Fix TRT-LLM NSA in target_verify/draft_extend"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DSv32] Overlap indexer qk projection and activation quant"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "[DSv32] Overlap indexer qk projection and activation quant"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] Add Kimi-K2, DeepSeek-V3.2 tests to nightly CI"; model line: DeepSeek V3/R1; category: bug fix; main diff: `test/registered/amd/accuracy/mi35x/test_deepseek_r1_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`; technical summary: Covers "[AMD] Add Kimi-K2, DeepSeek-V3.2 tests to nightly CI"; the main implementation surface is `test/registered/amd/accuracy/mi35x/test_deepseek_r1_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_eval_mi35x.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix OOM in DeepSeek weight loading by deferring dict(weights) materialization"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_common/deepseek_weight_loader.py`; technical summary: Covers "Fix OOM in DeepSeek weight loading by deferring dict(weights) materialization"; the main implementation surface is `python/sglang/srt/models/deepseek_common/deepseek_weight_loader.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix Bug on dsv3.2"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`; technical summary: Covers "Fix Bug on dsv3.2"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] Fix accuracy issue when running TP4 dsv3 model with mtp"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/aiter_backend.py`, `docker/rocm.Dockerfile`; technical summary: Covers "[AMD] Fix accuracy issue when running TP4 dsv3 model with mtp"; the main implementation surface is `python/sglang/srt/layers/attention/aiter_backend.py`, `docker/rocm.Dockerfile`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Fix model loading for DeepSeek-V3.2-AWQ"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "Fix model loading for DeepSeek-V3.2-AWQ"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "Nsa trtllm mla sparse fp8 support with Deepseek v3.2 NVFP4"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/models/deepseek_v2.py`, `test/registered/kernels/test_nsa_indexer.py`; technical summary: Covers "Nsa trtllm mla sparse fp8 support with Deepseek v3.2 NVFP4"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`, `python/sglang/srt/models/deepseek_v2.py`, `test/registered/kernels/test_nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[AMD] Fix mi35x dsv32 mtp nightly"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/nsa_backend.py`; technical summary: Covers "[AMD] Fix mi35x dsv32 mtp nightly"; the main implementation surface is `python/sglang/srt/layers/attention/nsa_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DSv32] [GLM5] Improve Model Quality by Avoiding FP32 Precision Loss in `weights_proj`"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `test/registered/kernels/test_nsa_indexer.py`; technical summary: Covers "[DSv32] [GLM5] Improve Model Quality by Avoiding FP32 Precision Loss in `weights_proj`"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `test/registered/kernels/test_nsa_indexer.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[DeepSeek-V3.2][JIT-kernel] Support nsa fuse store indexer k cache"; model line: DeepSeek V3/R1; category: performance/backend optimization; main diff: `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/jit_kernel/csrc/nsa/fused_store_index_cache.cuh`; technical summary: Covers "[DeepSeek-V3.2][JIT-kernel] Support nsa fuse store indexer k cache"; the main implementation surface is `python/sglang/srt/layers/attention/nsa/nsa_indexer.py`, `python/sglang/jit_kernel/csrc/nsa/fused_store_index_cache.cuh`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Tool Call] Stream DeepSeek-V3.2 function call parameters in JSON format."; model line: DeepSeek V3/R1; category: model support/runtime entry; main diff: `python/sglang/srt/function_call/deepseekv32_detector.py`; technical summary: Covers "[Tool Call] Stream DeepSeek-V3.2 function call parameters in JSON format."; the main implementation surface is `python/sglang/srt/function_call/deepseekv32_detector.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[AMD] CI - Add MI35x nightly/PR tests for kv-cache-fp8 and allreduce-fusion (DeepSeek)"; model line: DeepSeek V3/R1; category: bug fix; main diff: `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_kv_fp8_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_ar_fusion_eval_mi35x.py`, `.github/workflows/nightly-test-amd-rocm720.yml`; technical summary: Covers "[AMD] CI - Add MI35x nightly/PR tests for kv-cache-fp8 and allreduce-fusion (DeepSeek)"; the main implementation surface is `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_kv_fp8_eval_mi35x.py`, `test/registered/amd/accuracy/mi35x/test_deepseek_r1_mxfp4_ar_fusion_eval_mi35x.py`, `.github/workflows/nightly-test-amd-rocm720.yml`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[deepseekv3.2] fix get_k_and_s_triton kenel for 128K seqlen case bug"; model line: DeepSeek V3/R1; category: bug fix; main diff: `test/manual/layers/attention/nsa/test_get_k_scale_triton_kernel.py`, `python/sglang/srt/layers/attention/nsa/index_buf_accessor.py`, `test/manual/layers/attention/nsa/test_index_buf_accessor.py`; technical summary: Covers "[deepseekv3.2] fix get_k_and_s_triton kenel for 128K seqlen case bug"; the main implementation surface is `test/manual/layers/attention/nsa/test_get_k_scale_triton_kernel.py`, `python/sglang/srt/layers/attention/nsa/index_buf_accessor.py`, `test/manual/layers/attention/nsa/test_index_buf_accessor.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Trace source: preserved from an explicit existing history/skill citation
- Diff scope read: GitHub Pull Request files API returned 1 files, +1/-1, 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Fix gpu-fault issue when run deepseek-r1 and enable dp"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/layers/attention/aiter_backend.py`; technical summary: Covers "Fix gpu-fault issue when run deepseek-r1 and enable dp"; the main implementation surface is `python/sglang/srt/layers/attention/aiter_backend.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[JIT Kernel] Migrate dsv3_router_gemm from AOT sgl-kernel to JIT kernel"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/glm4_moe_lite.py`, `python/sglang/jit_kernel/csrc/gemm/dsv3_router_gemm.cuh`; technical summary: Covers "[JIT Kernel] Migrate dsv3_router_gemm from AOT sgl-kernel to JIT kernel"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/glm4_moe_lite.py`, `python/sglang/jit_kernel/csrc/gemm/dsv3_router_gemm.cuh`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Bugfix] Fix prepare_qkv_latent bypassing LoRA adapters in DeepSeek V2/V3"; model line: DeepSeek V3/R1; category: bug fix; main diff: `python/sglang/srt/models/deepseek_v2.py`; technical summary: Covers "[Bugfix] Fix prepare_qkv_latent bypassing LoRA adapters in DeepSeek V2/V3"; the main implementation surface is `python/sglang/srt/models/deepseek_v2.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[Bugfix] Guard .weight access in DeepseekV2AttentionMLA for AWQ / compressed-tensors"; model line: DeepSeek V3/R1; category: bug fix; main diff: `test/registered/unit/models/test_deepseek_v2_attention_mla.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mla_fused_rope_cpu.py`; technical summary: Covers "[Bugfix] Guard .weight access in DeepseekV2AttentionMLA for AWQ / compressed-tensors"; the main implementation surface is `test/registered/unit/models/test_deepseek_v2_attention_mla.py`, `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mla_fused_rope_cpu.py`. File-level evidence, code excerpts, and validation risks are preserved below.
...
- Motivation: Title: "[CPU] expand the interface of shared_expert without scaling factor"; model line: DeepSeek V3/R1; category: model implementation change; main diff: `sgl-kernel/csrc/cpu/moe_int4.cpp`, `sgl-kernel/csrc/cpu/moe.h`, `sgl-kernel/csrc/cpu/moe.cpp`; technical summary: Covers "[CPU] expand the interface of shared_expert without scaling factor"; the main implementation surface is `sgl-kernel/csrc/cpu/moe_int4.cpp`, `sgl-kernel/csrc/cpu/moe.h`, `sgl-kernel/csrc/cpu/moe.cpp`. File-level evidence, code excerpts, and validation risks are preserved below.
