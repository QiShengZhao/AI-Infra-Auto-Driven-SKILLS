...
Generated from sglang upstream `origin/main@5073c82a37`, `git log --name-only -- <model-files>` over model-related paths, and the GitHub Pull Request files API. This page fills the missing `Ring 2.5 1T` history entry found from sgl-cookbook coverage.

## Implementation File Coverage

| File | PRs traced by git |
| --- | --- |
| `skills/llm-serving-auto-benchmark/configs/cookbook-llm/ring-2.5-1t.yaml` | [#24250](https://github.com/sgl-project/sglang/pull/24250) |
| `docs_new/cookbook/autoregressive/InclusionAI/Ring-2.5-1T.mdx` | [#23337](https://github.com/sgl-project/sglang/pull/23337), [#23001](https://github.com/sgl-project/sglang/pull/23001) |
| `docs_new/src/snippets/autoregressive/ring-25-1t-deployment.jsx` | [#23001](https://github.com/sgl-project/sglang/pull/23001) |
...
| `test/registered/8-gpu-models/test_ring_2_5_1t.py` | [#22305](https://github.com/sgl-project/sglang/pull/22305), [#22267](https://github.com/sgl-project/sglang/pull/22267), [#22045](https://github.com/sgl-project/sglang/pull/22045), [#21751](https://github.com/sgl-project/sglang/pull/21751), [#19201](https://github.com/sgl-project/sglang/pull/19201), [#18829](https://github.com/sgl-project/sglang/pull/18829) |

## PR Coverage Summary

- git-traced PR count: 40
- keyword/supplemental PR count: 0
- total PR count in this document: 40
...
| 2026-02-14 | [#18829](https://github.com/sgl-project/sglang/pull/18829) | merged | Add ci test for ring model | `python/sglang/test/accuracy_test_runner.py`, `test/registered/8-gpu-models/test_ring_2_5_1t.py` |
...
| 2026-02-25 | [#19201](https://github.com/sgl-project/sglang/pull/19201) | merged | Add server CUDA graph warmup CI step for cold H200 nodes | `.github/workflows/pr-test.yml`, `scripts/ci/cuda/warmup_deep_gemm.py`, `scripts/ci/cuda/warmup_server.py` |
...
- Motivation: Title: "Support bailing moe"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `docs/supported_models/generative_models.md`, `python/sglang/srt/models/bailing_moe.py`, `test/srt/models/test_generation_models.py`.
- Key implementation:
...
- Motivation: Title: "Support LingV2 model"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `benchmark/kernels/fused_moe_triton/tuning_fused_moe_triton.py`, `python/sglang/srt/configs/model_config.py`, `python/sglang/srt/layers/linear.py`.
- Key implementation:
...
- Motivation: Title: "Fix Bailing MoE model bugs"; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/srt/models/bailing_moe.py`, `python/sglang/srt/server_args.py`.
- Key implementation:
...
- Motivation: Title: "Refactor TopK to ensure readability and extensibility"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/srt/layers/moe/ep_moe/layer.py`, `python/sglang/srt/layers/moe/fused_moe_triton/layer.py`, `python/sglang/srt/layers/moe/topk.py`.
- Key implementation:
...
- Motivation: Title: "fix bailing_moe with enable_dp_attention"; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/srt/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "Fuse write kv buffer into rope for qwen3 moe & bailing moe"; model line: Ring 2.5 1T; category: performance/backend optimization; main diff: `python/sglang/srt/models/bailing_moe.py`, `python/sglang/srt/models/gpt_oss.py`, `python/sglang/srt/models/qwen3_moe.py`.
- Key implementation:
...
- Motivation: Title: "Deprecate `global_server_args_dict`"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/global_config.py`, `python/sglang/srt/distributed/device_communicators/pynccl_allocator.py`, `python/sglang/srt/eplb/expert_location_dispatch.py`.
- Key implementation:
...
- Motivation: Title: "bailingMoE: Fix Key error of deepep_mode"; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/srt/models/bailing_moe.py`.
- Key implementation:
  - `python/sglang/srt/models/bailing_moe.py` modified +2/-2
- Code diff details:
  - `python/sglang/srt/models/bailing_moe.py` modified +2/-2
...
- Motivation: Title: "Revert "Deprecate `global_server_args_dict`""; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/global_config.py`, `python/sglang/srt/distributed/device_communicators/pynccl_allocator.py`, `python/sglang/srt/eplb/expert_location_dispatch.py`.
- Key implementation:
...
- Trace source: `git log --name-only -- <model-files>` or model-keyword supplement; this card was audited through the GitHub Pull Request files API.
- Diff scope read: GitHub Pull Request files API returned 54 files, +240/-321, with 1946 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Depreate `global_server_args_dict`"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/global_config.py`, `python/sglang/srt/distributed/device_communicators/pynccl_allocator.py`, `python/sglang/srt/eplb/expert_location_dispatch.py`.
- Key implementation:
  - `python/sglang/global_config.py` modified +0/-3
  - `python/sglang/srt/distributed/device_communicators/pynccl_allocator.py` modified +2/-2
  - `python/sglang/srt/eplb/expert_location_dispatch.py` modified +2/-2
...
- Motivation: Title: "[Lint] Add `python/sglang` to ruff F401 checks and remove unused imports in files"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `.pre-commit-config.yaml`, `python/sglang/srt/_custom_ops.py`, `python/sglang/srt/compilation/cuda_piecewise_backend.py`.
- Key implementation:
...
- Motivation: Title: "[9/N] MoE Refactor: cleanup dispatcher interfaces"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/srt/layers/dp_attention.py`, `python/sglang/srt/layers/moe/ep_moe/kernels.py`, `python/sglang/srt/layers/moe/ep_moe/layer.py`.
- Key implementation:
...
- Motivation: Title: "Enable bailing_moe to support TP=16"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `python/sglang/srt/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "remove unecessary dual stream token threshold from the rest of models (qwen moe, kimi linear, etc.)"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/srt/models/bailing_moe.py`, `python/sglang/srt/models/kimi_linear.py`, `python/sglang/srt/models/llada2.py`.
- Key implementation:
...
- Motivation: Title: "[bugfix] fix TBO crashes when attn_tp_size > 1"; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/srt/batch_overlap/operations.py`, `python/sglang/srt/batch_overlap/two_batch_overlap.py`, `python/sglang/srt/layers/communicator.py`.
- Key implementation:
...
- Motivation: Title: "Optimize Bailing-MoE with FlashInfer Fused All-Reduce"; model line: Ring 2.5 1T; category: performance/backend optimization; main diff: `python/sglang/srt/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "[Feature] JIT Fused QK norm + qk norm clean up"; model line: Ring 2.5 1T; category: performance/backend optimization; main diff: `python/sglang/jit_kernel/benchmark/bench_qknorm.py`, `python/sglang/jit_kernel/csrc/norm.cuh`, `python/sglang/jit_kernel/include/sgl_kernel/runtime.cuh`.
- Key implementation:
...
- Motivation: Title: "Fix EPLB + FP4 Quantization Compatibility Issue"; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/srt/layers/moe/utils.py`, `python/sglang/srt/models/bailing_moe.py`, `python/sglang/srt/models/deepseek_v2.py`.
- Key implementation:
...
- Motivation: Title: "Use attn tp group in embedding for more models"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/srt/models/bailing_moe.py`, `python/sglang/srt/models/bailing_moe_nextn.py`, `python/sglang/srt/models/falcon_h1.py`.
- Key implementation:
...
- Motivation: Title: "Fix the scenario where eh_proj is quantized in the bailing moe nextn weights"; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/srt/models/bailing_moe_nextn.py`.
- Key implementation:
...
- Motivation: Title: "feat: Add Ling Flash v2.0 support for Eagle3"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `python/sglang/srt/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "Support LingV2_5 model"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `python/sglang/srt/configs/__init__.py`, `python/sglang/srt/configs/bailing_hybrid.py`, `python/sglang/srt/configs/model_config.py`.
- Key implementation:
...
- Motivation: Title: "Cleanup debug log for Ring model"; model line: Ring 2.5 1T; category: bug fix; main diff: `python/sglang/srt/configs/mamba_utils.py`, `python/sglang/srt/models/bailing_moe_linear.py`.
- Key implementation:
...
- Trace source: `git log --name-only -- <model-files>` or model-keyword supplement; this card was audited through the GitHub Pull Request files API.
- Diff scope read: GitHub Pull Request files API returned 2 files, +66/-1, with 103 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Add ci test for ring model"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `python/sglang/test/accuracy_test_runner.py`, `test/registered/8-gpu-models/test_ring_2_5_1t.py`.
- Key implementation:
  - `python/sglang/test/accuracy_test_runner.py` modified +13/-1
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` added +53/-0; symbols: TestRing2_5_1T, test_ring_2_5_1t
- Code diff details:
  - `python/sglang/test/accuracy_test_runner.py` modified +13/-1
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` added +53/-0
- Key code excerpts:
...
```
- Reviewed files:
  - runtime: `python/sglang/test/accuracy_test_runner.py` modified +13/-1
  - tests: `test/registered/8-gpu-models/test_ring_2_5_1t.py` added +53/-0
- Risk and verification: The diff includes test or benchmark paths; rerun those checks plus a minimal launch/accuracy smoke before changing this model again.
...
- Motivation: Title: "update pre-commit config"; model line: Ring 2.5 1T; category: docs/tests/CI; main diff: `.github/workflows/lint.yml`, `.pre-commit-config.yaml`, `3rdparty/amd/tuning/benchmark_moe_rocm.py`.
- Key implementation:
...
- Trace source: `git log --name-only -- <model-files>` or model-keyword supplement; this card was audited through the GitHub Pull Request files API.
- Diff scope read: GitHub Pull Request files API returned 4 files, +739/-7, with 771 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "Add server CUDA graph warmup CI step for cold H200 nodes"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `.github/workflows/pr-test.yml`, `scripts/ci/cuda/warmup_deep_gemm.py`, `scripts/ci/cuda/warmup_server.py`.
- Key implementation:
  - `.github/workflows/pr-test.yml` modified +27/-6
  - `scripts/ci/cuda/warmup_deep_gemm.py` added +399/-0; symbols: get_config_json, is_deepseek_v2v3, compute_deepseek_v2v3_shapes, get_architecture_key
  - `scripts/ci/cuda/warmup_server.py` added +313/-0; symbols: get_version_key, get_marker_path, check_marker, write_marker
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +0/-1
- Code diff details:
  - `.github/workflows/pr-test.yml` modified +27/-6
  - `scripts/ci/cuda/warmup_deep_gemm.py` added +399/-0
  - `scripts/ci/cuda/warmup_server.py` added +313/-0
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +0/-1
- Key code excerpts:
...
- Reviewed files:
  ...
  - other: `.github/workflows/pr-test.yml` modified +27/-6; `scripts/ci/cuda/warmup_deep_gemm.py` added +399/-0; `scripts/ci/cuda/warmup_server.py` added +313/-0
- Risk and verification: The diff includes test or benchmark paths; rerun those checks plus a minimal launch/accuracy smoke before changing this model again.
...
- Motivation: Title: "Upgrade transformers==5.3.0"; model line: Ring 2.5 1T; category: docs/tests/CI; main diff: `docs/advanced_features/vlm_query.ipynb`, `python/pyproject.toml`, `python/pyproject_cpu.toml`.
- Key implementation:
...
- Motivation: Title: "[CPU] Add FP8 Bmm support"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `python/sglang/srt/models/bailing_moe_linear.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mla.py`, `python/sglang/srt/models/deepseek_common/attention_forward_methods/forward_mla_fused_rope_cpu.py`.
- Key implementation:
...
- Motivation: Title: "fix fused_set_kv_buffer for rope with Ling-v2"; model line: Ring 2.5 1T; category: performance/backend optimization; main diff: `python/sglang/srt/models/bailing_moe.py`.
- Key implementation:
...
- Trace source: `git log --name-only -- <model-files>` or model-keyword supplement; this card was audited through the GitHub Pull Request files API.
- Diff scope read: GitHub Pull Request files API returned 1 files, +2/-0, with 9 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[CI] Fix ring test timeout"; model line: Ring 2.5 1T; category: bug fix; main diff: `test/registered/8-gpu-models/test_ring_2_5_1t.py`.
- Key implementation:
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +2/-0
- Code diff details:
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +2/-0
- Key code excerpts:
...
- Trace source: `git log --name-only -- <model-files>` or model-keyword supplement; this card was audited through the GitHub Pull Request files API.
- Diff scope read: GitHub Pull Request files API returned 3 files, +5/-2, with 41 readable patch lines; this card prioritizes model-related and high-change files.
- Motivation: Title: "[CI] Adjust CI server launch timeout"; model line: Ring 2.5 1T; category: docs/tests/CI; main diff: `python/sglang/test/accuracy_test_runner.py`, `python/sglang/test/test_utils.py`, `test/registered/8-gpu-models/test_ring_2_5_1t.py`.
- Key implementation:
  - `python/sglang/test/accuracy_test_runner.py` modified +2/-2
  - `python/sglang/test/test_utils.py` modified +2/-0
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +1/-0
- Code diff details:
  - `python/sglang/test/accuracy_test_runner.py` modified +2/-2
  - `python/sglang/test/test_utils.py` modified +2/-0
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +1/-0
...
```
- Reviewed files:
  - runtime: `python/sglang/test/accuracy_test_runner.py` modified +2/-2; `python/sglang/test/test_utils.py` modified +2/-0
  - tests: `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +1/-0
- Risk and verification: The diff includes test or benchmark paths; rerun those checks plus a minimal launch/accuracy smoke before changing this model again.
...
- Motivation: Title: "Move ring test to nightly"; model line: Ring 2.5 1T; category: docs/tests/CI; main diff: `test/registered/8-gpu-models/test_ring_2_5_1t.py`.
- Key implementation:
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +3/-2
- Code diff details:
  - `test/registered/8-gpu-models/test_ring_2_5_1t.py` modified +3/-2
- Key code excerpts:
...
- Motivation: Title: "[CI] Update est_time for 64 tests based on actual elapsed times"; model line: Ring 2.5 1T; category: docs/tests/CI; main diff: `test/registered/4-gpu-models/test_nvidia_nemotron_3_super_nvfp4.py`, `test/registered/4-gpu-models/test_qwen35_hicache.py`, `test/registered/4-gpu-models/test_qwen3_30b.py`.
- Key implementation:
...
- Motivation: Title: "Add new Mintlify documentation site (docs_new/)"; model line: Ring 2.5 1T; category: model support/runtime entry; main diff: `.gitignore`, `docs_new/.github/workflows/sync-lmsys-sglang-blogs.yml`, `docs_new/.gitignore`.
- Key implementation:
...
- Motivation: Title: "[Docs] Sync docs_new with legacy docs and update migration redirects"; model line: Ring 2.5 1T; category: docs/tests/CI; main diff: `.pre-commit-config.yaml`, `docs_new/cookbook/autoregressive/DeepSeek/DeepSeek-Math-V2.mdx`, `docs_new/cookbook/autoregressive/DeepSeek/DeepSeek-OCR-2.mdx`.
- Key implementation:
...
- Motivation: Title: "Apply should_use_dp_reduce_scatterv guard to remaining MoE models (follow-up to #23731)"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/srt/models/bailing_moe.py`, `python/sglang/srt/models/bailing_moe_linear.py`, `python/sglang/srt/models/deepseek_v2.py`.
- Key implementation:
...
- Motivation: Title: "refactor(moe): centralize post-experts all-reduce skip predicate"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/srt/layers/moe/__init__.py`, `python/sglang/srt/layers/moe/utils.py`, `python/sglang/srt/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "[SKILL] Upgrade sglang profile and auto_benchmark skills"; model line: Ring 2.5 1T; category: docs/tests/CI; main diff: `agent-skills/llm-serving-auto-benchmark/SKILL.md`, `skills/llm-serving-auto-benchmark/configs/cookbook-llm/README.md`, `skills/llm-serving-auto-benchmark/configs/cookbook-llm/deepseek-math-v2.yaml`.
- Key implementation:
...
- Motivation: Title: "nextn subclass owns post_load_weights is_nextn"; model line: Ring 2.5 1T; category: model implementation change; main diff: `python/sglang/srt/model_loader/loader.py`, `python/sglang/srt/model_loader/utils.py`, `python/sglang/srt/models/bailing_moe_nextn.py`.
- Key implementation:
