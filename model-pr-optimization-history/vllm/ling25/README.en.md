...
- Motivation: Title: "[Model] Add Ling implementation"; model line: Ling 2.5 1T; category: model support/runtime entry; main diff: `docs/models/supported_models.md`, `tests/models/registry.py`, `vllm/model_executor/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "[Model] Remove model sampler"; model line: Ling 2.5 1T; category: model implementation change; main diff: `vllm/model_executor/models/bailing_moe.py`, `vllm/model_executor/models/granite_speech.py`, `vllm/model_executor/models/hunyuan_v1_moe.py`.
- Key implementation:
...
- Motivation: Title: "[Quantization] Enable BNB support for more MoE models"; model line: Ling 2.5 1T; category: model support/runtime entry; main diff: `docs/models/supported_models.md`, `vllm/model_executor/models/bailing_moe.py`, `vllm/model_executor/models/ernie45_moe.py`.
- Key implementation:
...
- Motivation: Title: "support `torch.compile` for bailing moe"; model line: Ling 2.5 1T; category: model support/runtime entry; main diff: `vllm/model_executor/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "[Models] Improve iteration over layers"; model line: Ling 2.5 1T; category: model implementation change; main diff: `vllm/model_executor/models/arcee.py`, `vllm/model_executor/models/arctic.py`, `vllm/model_executor/models/baichuan.py`.
- Key implementation:
...
- Motivation: Title: "[Model]: support Ling2.0"; model line: Ling 2.5 1T; category: model support/runtime entry; main diff: `docs/models/supported_models.md`, `tests/models/registry.py`, `vllm/model_executor/models/bailing_moe.py`.
- Key implementation:
  - `docs/models/supported_models.md` modified +1/-0
  - `tests/models/registry.py` modified +2/-0
...
- Motivation: Title: "[V0 Deprecation] Remove V0 sampling metadata"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `tests/plugins/vllm_add_dummy_model/vllm_add_dummy_model/my_llava.py`, `tests/plugins/vllm_add_dummy_model/vllm_add_dummy_model/my_opt.py`, `vllm/model_executor/__init__.py`.
- Key implementation:
...
- Motivation: Title: "Move`VllmConfig` from `config/__init__.py` to `config/vllm.py`"; model line: Ling 2.5 1T; category: model implementation change; main diff: `vllm/attention/layer.py`, `vllm/attention/layers/chunked_local_attention.py`, `vllm/config/__init__.py`.
- Key implementation:
...
- Motivation: Title: "Convert formatting to use `ruff` instead of `yapf` + `isort`"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `.buildkite/pyproject.toml`, `.pre-commit-config.yaml`, `benchmarks/benchmark_block_pool.py`.
- Key implementation:
...
- Motivation: Title: "Fix per file ruff ignores related to line length"; model line: Ling 2.5 1T; category: bug fix; main diff: `benchmarks/benchmark_ngram_proposer.py`, `benchmarks/benchmark_serving_structured_output.py`, `csrc/cutlass_extensions/vllm_cutlass_library_extension.py`.
- Key implementation:
  - `benchmarks/benchmark_ngram_proposer.py` modified +1/-1
...
- Motivation: Title: "[Model] Apply shared experts overlap optimization to all models with shared experts"; model line: Ling 2.5 1T; category: model implementation change; main diff: `vllm/model_executor/layers/fused_moe/__init__.py`, `vllm/model_executor/layers/fused_moe/shared_fused_moe.py`, `vllm/model_executor/layers/quantization/fp8.py`.
- Key implementation:
...
- Motivation: Title: "Update `Optional[x]` -> `x | None` and `Union[x, y]` to `x | y`"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `benchmarks/backend_request_func.py`, `benchmarks/benchmark_prefix_caching.py`, `benchmarks/benchmark_prioritization.py`.
- Key implementation:
...
- Motivation: Title: "[Fix] Remove divisibility requirement between num_kv_heads and tp_size in bailing_moe"; model line: Ling 2.5 1T; category: bug fix; main diff: `vllm/model_executor/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "[LoRA][1/N]Remove LoRA extra vocab"; model line: Ling 2.5 1T; category: model implementation change; main diff: `vllm/model_executor/models/apertus.py`, `vllm/model_executor/models/arcee.py`, `vllm/model_executor/models/arctic.py`.
- Key implementation:
...
- Motivation: Title: "Rename clashing method names for vLLM model protocol"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `docs/contributing/model/basic.md`, `docs/contributing/model/multimodal.md`, `vllm/model_executor/models/apertus.py`.
- Key implementation:
...
- Motivation: Title: "[Model] Fix bailing_moe accuracy problem"; model line: Ling 2.5 1T; category: bug fix; main diff: `vllm/model_executor/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "[Model] Fix lmhead init bug of bailing_moe"; model line: Ling 2.5 1T; category: bug fix; main diff: `vllm/model_executor/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "Update `rope_scaling` to `rope_parameters` in preparation for Transformers v5"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `.buildkite/test-pipeline.yaml`, `benchmarks/kernels/benchmark_mrope.py`, `examples/offline_inference/context_extension.py`.
- Key implementation:
...
- Motivation: Title: "[Attention] Remove imports from `vllm/attention/__init__.py`"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `docs/contributing/model/basic.md`, `tests/compile/test_fusion_attn.py`, `tests/compile/test_qk_norm_rope_fusion.py`.
- Key implementation:
...
- Motivation: Title: "Access `partial_rotary_factor` from `rope_parameters`"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `tests/kernels/core/test_mrope.py`, `vllm/model_executor/layers/rotary_embedding/__init__.py`, `vllm/model_executor/models/apertus.py`.
- Key implementation:
...
- Motivation: Title: "Standardise `get_rope` to use `rope_parameters["partial_rotary_factor"]`, not `rotary_dim`"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `benchmarks/kernels/benchmark_mrope.py`, `benchmarks/kernels/benchmark_rope.py`, `tests/compile/test_functionalization.py`.
- Key implementation:
...
- Motivation: Title: "[BugFix] LoRA: Support loading base_layer of experts"; model line: Ling 2.5 1T; category: bug fix; main diff: `vllm/model_executor/layers/fused_moe/layer.py`, `vllm/model_executor/models/afmoe.py`, `vllm/model_executor/models/bailing_moe.py`.
- Key implementation:
...
- Motivation: Title: "[Chore] Update type annotation of `input_ids` in model forward"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `docs/contributing/model/basic.md`, `tests/plugins/vllm_add_dummy_model/vllm_add_dummy_model/my_gemma_embedding.py`, `vllm/model_executor/models/afmoe.py`.
- Key implementation:
  - `docs/contributing/model/basic.md` modified +1/-1
...
- Motivation: Title: "[5/N][Attention] Finish eliminating `vllm/attention` folder"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `.buildkite/test-amd.yaml`, `.buildkite/test-pipeline.yaml`, `.buildkite/test_areas/kernels.yaml`.
- Key implementation:
...
- Motivation: Title: "[Bugfix] Define router_logits_dtype for remaining MoE models"; model line: Ling 2.5 1T; category: bug fix; main diff: `vllm/model_executor/models/afmoe.py`, `vllm/model_executor/models/bailing_moe.py`, `vllm/model_executor/models/flex_olmo.py`.
- Key implementation:
  - `vllm/model_executor/models/afmoe.py` modified +1/-0
  - `vllm/model_executor/models/bailing_moe.py` modified +1/-0
...
- Motivation: Title: "[Model] Ring 2.5"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `docs/models/supported_models.md`, `tests/models/registry.py`, `vllm/model_executor/layers/fla/ops/layernorm_guard.py`.
- Key implementation:
  - `docs/models/supported_models.md` modified +1/-0
...
- Motivation: Title: "[V0 Deprecation] Deprecate virtual engine"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `tests/compile/passes/test_rope_kvcache_fusion.py`, `tests/v1/kv_connector/unit/test_decode_bench_connector.py`, `tests/v1/kv_connector/unit/test_lmcache_integration.py`.
- Key implementation:
...
- Motivation: Title: "[V0 Deprecation] Refactor kv cache from list to element"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `tests/compile/passes/test_fusion_attn.py`, `tests/compile/passes/test_rope_kvcache_fusion.py`, `tests/v1/e2e/general/test_mamba_prefix_cache.py`.
- Key implementation:
...
- Motivation: Title: "[MoE Refactor] Remove SharedFusedMoE class"; model line: Ling 2.5 1T; category: performance/backend optimization; main diff: `tests/kernels/moe/test_moe_layer.py`, `tests/kernels/moe/test_shared_fused_moe_routed_transform.py`, `vllm/distributed/device_communicators/base_device_communicator.py`.
- Key implementation:
...
- Motivation: Title: "[Bugfix ] fix bailing_moe_linear"; model line: Ling 2.5 1T; category: bug fix; main diff: `vllm/model_executor/layers/mamba/mamba_utils.py`, `vllm/model_executor/models/bailing_moe_linear.py`.
- Key implementation:
...
- Motivation: Title: "[Bugfix] BailingMoeV2.5: rotate full qk_rope_head_dim in MLA RoPE"; model line: Ling 2.5 1T; category: bug fix; main diff: `vllm/model_executor/models/bailing_moe_linear.py`.
- Key implementation:
...
- Motivation: Title: "[Misc] Replace mamba_type string literals with MambaAttentionBackendEnum"; model line: Ling 2.5 1T; category: docs/tests/CI; main diff: `docs/contributing/model/basic.md`, `tests/kernels/mamba/test_ssu_dispatch.py`, `tests/v1/attention/test_attention_backends_selection.py`.
- Key implementation:
  - `docs/contributing/model/basic.md` modified +1/-1
