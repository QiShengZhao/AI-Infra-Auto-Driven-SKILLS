...
- 动机: 标题「[Model] use AutoWeightsLoader for phimoe,qwen2_moe,qwen3_moe」；模型线: Qwen3 Core；类别: 缺陷修复；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；技术摘要: 覆盖「[Model] use AutoWeightsLoader for phimoe,qwen2_moe,qwen3_moe」；主要实现面是 `vllm/model_executor/models/qwen3_moe.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Model] Add packed_modules_mapping for Qwen3-MOE」；模型线: Qwen3 Core；类别: 模型支持/运行时入口；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；未提供可用技术摘要。
...
- 动机: 标题「[Chore]: qwen3-moe-type-hints-mistake」；模型线: Qwen3 Core；类别: 模型实现调整；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；未提供可用技术摘要。
...
- 动机: 标题「[Bugfix] Skip loading extra parameters for modelopt Qwen3 MoE model」；模型线: Qwen3 Core；类别: 缺陷修复；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；未提供可用技术摘要。
...
- 动机: 标题「[Feature][EPLB] Add eplb support for Qwen3」；模型线: Qwen3 Core；类别: 模型支持/运行时入口；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；未提供可用技术摘要。
...
- 动机: 标题「[Qwen3] Enable dual-chunk-attention support for Qwen3 models.」；模型线: Qwen3 Core；类别: 模型支持/运行时入口；主要 diff: `vllm/model_executor/models/qwen3.py`, `vllm/model_executor/models/qwen3_moe.py`；未提供可用技术摘要。
...
- 动机: 标题「Add ModelOpt Qwen3 nvfp4 support」；模型线: Qwen3 Core；类别: 性能/后端优化；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；未提供可用技术摘要。
...
- 动机: 标题「[Model] Removes redundant all-reduce operation in Qwen3MoeSparseMoeBlock」；模型线: Qwen3 Core；类别: 性能/后端优化；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；技术摘要: 覆盖「[Model] Removes redundant all-reduce operation in Qwen3MoeSparseMoeBlock」；主要实现面是 `vllm/model_executor/models/qwen3_moe.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「Add EAGLE-3 Speculative Decoding Support for Qwen3 MoE」；模型线: Qwen3 Core；类别: 文档/测试/CI；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；技术摘要: 覆盖「Add EAGLE-3 Speculative Decoding Support for Qwen3 MoE」；主要实现面是 `vllm/model_executor/models/qwen3_moe.py`。下方保留文件级证据、代码摘录和验证风险。
...
- 动机: 标题「[Models] Add `SharedFusedMoE` support to Qwen3MoE」；模型线: Qwen3 Core；类别: 缺陷修复；主要 diff: `vllm/model_executor/models/qwen3_moe.py`；技术摘要: 覆盖「[Models] Add `SharedFusedMoE` support to Qwen3MoE」；主要实现面是 `vllm/model_executor/models/qwen3_moe.py`。下方保留文件级证据、代码摘录和验证风险。
