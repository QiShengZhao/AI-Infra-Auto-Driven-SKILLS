...
- total PR count in this document: 31
...
- Motivation: Title: "[Model] Upstream Deepseek-OCR model"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `docs/models/supported_models.md`, `examples/offline_inference/vision_language.py`, `tests/models/registry.py`.
- Key implementation:
...
- Motivation: Title: "[Bugfix] Fix deepseek-ocr multi-image inference and add `merge_by_field_config=True` with tensor schema support"; model line: DeepSeek OCR; category: bug fix; main diff: `examples/offline_inference/vision_language_multi_image.py`, `tests/models/multimodal/processing/test_common.py`, `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "[Bugfix] Validate custom logits processor xargs for online serving"; model line: DeepSeek OCR; category: bug fix; main diff: `docs/design/logits_processors.md`, `docs/features/custom_arguments.md`, `docs/features/custom_logitsprocs.md`.
- Key implementation:
...
- Motivation: Title: "[Model] Consolidate Deepseek-MoE implementation with DeepSeek-v2"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `tests/models/registry.py`, `vllm/model_executor/models/deepseek.py`, `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "Rename clashing method names for vLLM model protocol"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `docs/contributing/model/basic.md`, `docs/contributing/model/multimodal.md`, `vllm/model_executor/models/apertus.py`.
- Key implementation:
...
- Motivation: Title: "[BugFix] DeepSeek-OCR: apply NoRepeatNGramLogitsProcessor to greedy path"; model line: DeepSeek OCR; category: bug fix; main diff: `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "[Chore] Move tokenizer initialization methods"; model line: DeepSeek OCR; category: model support/runtime entry; main diff: `benchmarks/benchmark_prefix_caching.py`, `benchmarks/benchmark_serving_structured_output.py`, `tests/compile/test_dynamic_shapes_compilation.py`.
- Key implementation:
...
- Motivation: Title: "[Chore] Deprecate `merge_by_field_config` arg"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `tests/models/multimodal/processing/test_common.py`, `tests/models/multimodal/processing/test_glm4_1v.py`, `tests/models/multimodal/processing/test_tensor_schema.py`.
- Key implementation:
...
- Motivation: Title: "[Chore] Deprecate `SupportsMultiModal.merge_by_field_config`"; model line: DeepSeek OCR; category: model support/runtime entry; main diff: `vllm/model_executor/models/aria.py`, `vllm/model_executor/models/aya_vision.py`, `vllm/model_executor/models/blip2.py`.
- Key implementation:
...
- Motivation: Title: "[Renderer] Separate out `RendererConfig` from `ModelConfig`"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `docs/contributing/model/transcription.md`, `tests/compile/distributed/test_sequence_parallelism.py`, `tests/compile/test_functionalization.py`.
- Key implementation:
...
- Motivation: Title: "Revert "[Renderer] Separate out `RendererConfig` from `ModelConfig` (#30145)""; model line: DeepSeek OCR; category: bug fix; main diff: `docs/contributing/model/transcription.md`, `tests/compile/distributed/test_sequence_parallelism.py`, `tests/compile/test_functionalization.py`.
- Key implementation:
  - `docs/contributing/model/transcription.md` modified +6/-6
...
- Motivation: Title: "feat: support LoRA for DeepSeek-OCR(Language Model part)"; model line: DeepSeek OCR; category: model support/runtime entry; main diff: `docs/models/supported_models.md`, `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "[Model] Standardize common vision encoders"; model line: DeepSeek OCR; category: model implementation change; main diff: `vllm/model_executor/models/clip.py`, `vllm/model_executor/models/deepencoder.py`, `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "[Model] Remove redundant None check in DeepSeekOCR image input processing"; model line: DeepSeek OCR; category: model implementation change; main diff: `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "[1/N] Reorganize multimodal processing code"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `docs/api/README.md`, `docs/contributing/model/multimodal.md`, `docs/design/mm_processing.md`.
- Key implementation:
...
- Motivation: Title: "[1/N] Initialize MM components in context managers (A-D)"; model line: DeepSeek OCR; category: model support/runtime entry; main diff: `vllm/model_executor/models/aria.py`, `vllm/model_executor/models/audioflamingo3.py`, `vllm/model_executor/models/aya_vision.py`.
- Key implementation:
...
- Motivation: Title: "[Models]: Make Multimodal config implicit in ViT implementation"; model line: DeepSeek OCR; category: model implementation change; main diff: `vllm/model_executor/layers/attention/mm_encoder_attention.py`, `vllm/model_executor/models/clip.py`, `vllm/model_executor/models/deepencoder.py`.
- Key implementation:
...
- Motivation: Title: "[Chore] Update type annotation of `input_ids` in model forward"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `docs/contributing/model/basic.md`, `tests/plugins/vllm_add_dummy_model/vllm_add_dummy_model/my_gemma_embedding.py`, `vllm/model_executor/models/afmoe.py`.
- Key implementation:
...
- Motivation: Title: "[Models] Consolidate Deepseek-OCR2 processor"; model line: DeepSeek OCR; category: model implementation change; main diff: `vllm/model_executor/models/deepencoder2.py`, `vllm/model_executor/models/deepseek_ocr.py`, `vllm/model_executor/models/deepseek_ocr2.py`.
- Key implementation:
...
- Motivation: Title: "[Multimodal] Expose `mm_processor_kwargs` for `DummyInputsBuilder`"; model line: DeepSeek OCR; category: model implementation change; main diff: `vllm/model_executor/models/aria.py`, `vllm/model_executor/models/audioflamingo3.py`, `vllm/model_executor/models/aya_vision.py`.
- Key implementation:
...
- Motivation: Title: "Fix DeepSeek-OCR tensor validation for all size variants"; model line: DeepSeek OCR; category: bug fix; main diff: `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "[Refactor] Simplify dummy data generation"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `docs/contributing/model/multimodal.md`, `tests/models/multimodal/processing/test_audioflamingo3.py`, `tests/models/multimodal/processing/test_common.py`.
- Key implementation:
...
- Motivation: Title: "[Misc] Lazy import registered processors"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `tests/models/registry.py`, `vllm/model_executor/models/deepseek_vl2.py`, `vllm/model_executor/models/fireredasr2.py`.
- Key implementation:
...
- Motivation: Title: "[Bugfix][Model] Fix DeepSeek-OCR TensorSchema crash on empty images_crop"; model line: DeepSeek OCR; category: bug fix; main diff: `tests/models/multimodal/processing/test_deepseek_ocr.py`, `vllm/model_executor/models/deepseek_ocr.py`.
- Key implementation:
...
- Motivation: Title: "[Bugfix] Standardize custom HF Processor init"; model line: DeepSeek OCR; category: bug fix; main diff: `vllm/model_executor/models/deepseek_ocr.py`, `vllm/model_executor/models/deepseek_ocr2.py`, `vllm/model_executor/models/glm4v.py`.
- Key implementation:
...
- Motivation: Title: "[Misc] Reorganize inputs"; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `docs/api/README.md`, `docs/contributing/model/transcription.md`, `docs/features/multimodal_inputs.md`.
- Key implementation:
...
- Motivation: Title: "[Examples] Resettle generate examples."; model line: DeepSeek OCR; category: docs/tests/CI; main diff: `.buildkite/test-amd.yaml`, `.buildkite/test_areas/misc.yaml`, `.buildkite/test_areas/model_runner_v2.yaml`.
- Key implementation:
...
- Motivation: Title: "[MM][CG] Support ViT CG for Qwen2.5-VL"; model line: DeepSeek OCR; category: model support/runtime entry; main diff: `docs/design/cuda_graphs_multimodal.md`, `examples/generate/multimodal/vision_language_offline.py`, `tests/models/multimodal/generation/test_qwen2_5_vl.py`.
- Key implementation:
...
- Motivation: Title: "[MM][CG] Support ViT CG for Qwen2-VL"; model line: DeepSeek OCR; category: model support/runtime entry; main diff: `docs/design/cuda_graphs_multimodal.md`, `examples/generate/multimodal/vision_language_offline.py`, `tests/models/multimodal/generation/test_vit_cudagraph.py`.
- Key implementation:
...
- Motivation: Title: "[MM][Perf][CG] Support ViT full CUDA graph for Qwen3.5"; model line: DeepSeek OCR; category: performance/backend optimization; main diff: `docs/design/cuda_graphs_multimodal.md`, `examples/generate/multimodal/vision_language_offline.py`, `tests/models/multimodal/generation/test_vit_cudagraph.py`.
- Key implementation:
  - `docs/design/cuda_graphs_multimodal.md` modified +2/-1
...
- Motivation: Title: "[MM][CG] Enable encoder Cudagraph for Step3VL"; model line: DeepSeek OCR; category: model support/runtime entry; main diff: `docs/design/cuda_graphs_multimodal.md`, `examples/generate/multimodal/vision_language_offline.py`, `tests/models/multimodal/generation/test_vit_cudagraph.py`.
- Key implementation:
  - `docs/design/cuda_graphs_multimodal.md` modified +2/-0
  - `examples/generate/multimodal/vision_language_offline.py` modified +1/-0
